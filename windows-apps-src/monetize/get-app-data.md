...
| hasAdvancedListingPermission        | object  |  アプリの申請用に [gamingOptions](manage-app-submissions.md#gaming-options-object) または[トレーラー](manage-app-submissions.md#trailer-object)を構成できるかどうかを示します。 詳しくは、[このセクション](manage-app-submissions.md#advanced-listings)をご覧ください。 |  |

...
実験のパラメーターに問題がなく、実験をアクティブ化する準備ができたら、**[アクティブ化]** をクリックして、アプリから実験データの収集を開始することができます。 実験がアクティブになって、アプリはバリエーションの変数を取得し、パートナー センターにビュー イベントとコンバージョン イベントを報告できます。 詳細については、[実行および管理のパートナー センターで実験](manage-your-experiment.md)を参照してください。

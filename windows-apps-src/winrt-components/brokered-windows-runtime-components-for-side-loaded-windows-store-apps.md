...
参照が適切に構成されたら、次は、サーバーの機能を実装する必要があります。 MSDN トピックの「[Windows ランタイム コンポーネントとの相互運用性のベスト プラクティス (C\#/VB/C++ と XAML を使った Windows ストア アプリ)](https://msdn.microsoft.com/library/windows/apps/hh750311.aspx)」をご覧ください。
...
標準の Windows ストア アプリ パッケージ内で使うプロキシとスタブを作成および登録するプロセスについては、「[Windows ランタイム コンポーネントでのイベントを生成する](https://msdn.microsoft.com/library/windows/apps/dn169426.aspx)」を参照してください。
...
-   [アプリ コントラクトと拡張機能 (Windows ストア アプリ)](https://msdn.microsoft.com/library/windows/apps/hh464906.aspx)

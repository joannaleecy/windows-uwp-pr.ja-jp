...
3. ブラウザーでデバイス ポータルのページに移動します。 次の表は、ポートと各デバイス ファミリで使用するプロトコルを示します。
...
このページを表示して、サイドローディングされたアプリによって保存されたファイルを操作できます。 投稿する、エクスプ ローラーとその使用方法について詳しくは、[アプリのエクスプ ローラーを使って](https://blogs.windows.com/buildingapps/2016/06/08/using-the-app-file-explorer-to-see-your-app-data/)ブログを参照してください。 
...
> [!IMPORTANT]
> この保護によっては、スタンドアロン クライアント (など、コマンド ライン ユーティリティなど) から REST Api の使用できなくなります。 これは 3 つの方法で解決できます。 

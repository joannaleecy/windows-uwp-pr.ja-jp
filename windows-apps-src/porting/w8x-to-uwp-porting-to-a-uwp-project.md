...
1.  Microsoft Visual Studio 2015 を起動し、"新しいアプリケーション (Windows ユニバーサル)" プロジェクトを新規作成します。 さらに詳しい情報は、「 [Jumpstart Windows ランタイム 8.x アプリ (c#、C++、Visual Basic) テンプレートを使用する](https://msdn.microsoft.com/library/windows/apps/hh768232)」を参照してください。 新しいプロジェクトによって、すべてのデバイス ファミリで実行される 1 つのアプリ パッケージ (appx ファイル) が構築されます。
...
* [Jumpstart、Windows ランタイム 8.x アプリのテンプレート (c#、C Visual Basic) を使用します。](https://msdn.microsoft.com/library/windows/apps/hh768232)

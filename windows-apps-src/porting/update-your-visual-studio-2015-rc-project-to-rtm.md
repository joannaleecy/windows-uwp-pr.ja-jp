...
# <a name="update-your-uwp-microsoft-visual-studio-2015-rc-project-to-rtm"></a>UWP Microsoft Visual Studio 2015 RC プロジェクトを RTM に更新する
...
## <a name="what-you-see-when-you-open-a-windows-10visual-studio-2015-rc-project-in-visual-studio-2015-rtm"></a>Visual Studio 2015 RTM で Windows 10Visual Studio 2015 RC プロジェクトを開いたときの表示内容
...
## <a name="create-a-new-project-and-copy-files-into-it"></a>新しいプロジェクトを作成し、ファイルをコピーする
...
## <a name="advanced-edit-your-existing-project-files"></a>詳細設定: 既存のプロジェクト ファイルを編集する

...
* [Windows.Foundation.AsyncOperationProgressHandler < Tresult、します。TProgress >](https://msdn.microsoft.com/library/windows/apps/br206573.aspx(d=robot))
* [Windows.Foundation.AsyncOperationWithProgressCompletedHandler < Tresult、します。TProgress >](https://msdn.microsoft.com/library/windows/apps/Windows.Foundation.AsyncOperationWithProgressCompletedHandler<Tresult,.TProgress>)
* [Windows.Foundation.Collections.MapChangedEventHandler < K、します。V >](https://msdn.microsoft.com/library/windows/apps/br206644.aspx)
...
* [Windows.Foundation.TypedEventHandler < 際、します。TResult >](https://msdn.microsoft.com/library/windows/apps/br225997.aspx(d=robot))

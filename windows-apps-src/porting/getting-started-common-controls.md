...
| 地図ビュー (MKMapView) と地図ビュー デリゲート (MKMapViewDelegate) | [UWP アプリ用 Bing Maps](https://go.microsoft.com/fwlink/p/?LinkId=263496)を参照してください。 |
...
* [Build 2014: XAML UI とコントロールの説明](https://go.microsoft.com/fwlink/p/?LinkID=397897)
* [Build 2014: 共通の XAML UI フレームワークを使ったアプリの開発](https://go.microsoft.com/fwlink/p/?LinkID=397898)
* [Build 2014: Visual Studio を使った XAML 集約型アプリの構築に関するページ](https://go.microsoft.com/fwlink/p/?LinkID=397876)

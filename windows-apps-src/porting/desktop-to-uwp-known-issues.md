...
### <a name="your-net-application-is-compiled-with-the-anycpu-build-option-and-fails-to-install"></a>.NET アプリケーションが"AnyCPU"ビルド オプションでコンパイルされ、インストールに失敗するには
...
**Certutil**をコマンドラインから PFX ファイルで実行し、出力から*の件名*をコピーします。

...
**メモ** JavaScript と HTML を使用して UWP アプリのナビゲーションについては、次を参照してください。[クイック スタート: 1 ページ ナビゲーションを使用して](https://msdn.microsoft.com/library/windows/apps/hh452768)します。

...
| **Microsoft.Phone.Scheduler.Alarm** クラス | [**BackgroundTaskBuilder** ](https://msdn.microsoft.com/library/windows/apps/br224768)と[ **ToastNotificationManager** ](https://msdn.microsoft.com/library/windows/apps/br208642)クラス |
...
| **Microsoft.Phone.Scheduler.Reminder** クラス | [**BackgroundTaskBuilder** ](https://msdn.microsoft.com/library/windows/apps/br224768)と[ **ToastNotificationManager** ](https://msdn.microsoft.com/library/windows/apps/br208642)クラス |
...
| **System.ComponentModel.DesignerProperties** クラス | [**デザイン モード**](https://msdn.microsoft.com/library/windows/apps/br224664)クラス |
...
| (MPU = **Microsoft.Phone.UserData**) <br/> **MPU.Account**、**ContactAddress**、**ContactCompanyInformation**、**ContactEmailAddress**、**ContactPhoneNumber** クラス | [**連絡先**](https://msdn.microsoft.com/library/windows/apps/br224849)クラス |
...
| (MPC = **Microsoft.Phone.Controls**) <br/> **MPC.ContextMenu** クラス | [**ポップアップ メニュー** ](https://msdn.microsoft.com/library/windows/apps/br208693)クラス |
...
| (MPC = **Microsoft.Phone.Controls**) <br/>**MPC.Panorama** クラス | [**ハブ**](https://msdn.microsoft.com/library/windows/apps/dn251843)クラス |
| (MPC = **Microsoft.Phone.Controls**) <br/>**MPC.PhoneApplicationFrame** クラス、<br/>(SWN = **System.Windows.Navigation**) <br/>**SWN.NavigationService** クラス | [**フレーム**](https://msdn.microsoft.com/library/windows/apps/br242682)クラス |
| (MPC = **Microsoft.Phone.Controls**) <br/>**MPC.PhoneApplicationPage** クラス | [**ページ**](https://msdn.microsoft.com/library/windows/apps/br227503)クラス |
...
| (MPC = **Microsoft.Phone.Controls**) <br/>**MPC.WrapPanel** クラス | 一般的なレイアウトの目的で直接相当する要素はありません。 [**ItemsWrapGrid** ](https://msdn.microsoft.com/library/windows/apps/dn298849)と[ **WrapGrid** ](https://msdn.microsoft.com/library/windows/apps/br227717)アイテム コントロールの項目のパネルのテンプレートで使用できます。 |
...
| **System.Windows.Controls.WrapPanel** クラス | 一般的なレイアウトの目的で直接相当する要素はありません。 [**ItemsWrapGrid** ](https://msdn.microsoft.com/library/windows/apps/dn298849)と[ **WrapGrid** ](https://msdn.microsoft.com/library/windows/apps/br227717)アイテム コントロールの項目のパネルのテンプレートで使用できます。 |
...
| **System.Windows.UIElement.Tap** イベント、**EventHandler&lt;GestureEventArgs&gt;** デリゲート | [**タップされた**](https://msdn.microsoft.com/library/windows/apps/br208985)イベント、 [ **TappedEventHandler** ](https://msdn.microsoft.com/library/windows/apps/br227993)デリゲート |
| データとサービス |  |
...
| **Microsoft.Devices.Sensors.Gyroscope** クラス | [**ジャイロ メーター** ](https://msdn.microsoft.com/library/windows/apps/br225718)クラス |
| **Microsoft.Devices.Sensors.Motion** クラス | [**傾斜計**](https://msdn.microsoft.com/library/windows/apps/br225766)クラス |
| Globalization | |
...
| グラフィックスとアニメーション | |
| **Microsoft.Xna.Framework します。\*** 名前空間、 [XNA Framework クラス ライブラリ](https://go.microsoft.com/fwlink/p/?LinkId=263769)、[コンテンツ パイプラインのクラス ライブラリ](https://go.microsoft.com/fwlink/p/?LinkId=263770) | 直接相当する要素はなし。 一般的に、C++ と共に [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) を使います。 「[ゲームの開発](https://msdn.microsoft.com/library/windows/apps/hh452744)」と「[DirectX と XAML の相互運用機能](https://msdn.microsoft.com/library/windows/apps/hh825871)」をご覧ください。 |
...
| **Microsoft.Xna.Framework.GamerServices** 名前空間 | (WPS = **Windows.Phone.System**) <br/> [**WPS します。UserProfile.GameServices.Core** ](https://msdn.microsoft.com/library/windows/apps/jj207609)名前空間 |
...
| **Microsoft.Phone.Tasks.ConnectionSettingsTask**、**MarketplaceHubTask**、**MarketplaceReviewTask**、**MarketplaceSearchTask**、**MediaPlayerLauncher**、**SearchTask**、**SmsComposeTask**、**WebBrowserTask** クラス | [**ランチャー** ](https://msdn.microsoft.com/library/windows/apps/br241801)クラス |
...
| ネットワーク | |
| (MPNN = **Microsoft.Phone.Net.NetworkInformation**) <br/> **MPNN.DeviceNetworkInformation** クラス | [**ホスト名**](https://msdn.microsoft.com/library/windows/apps/br207113)、 [ **NetworkInformation** ](https://msdn.microsoft.com/library/windows/apps/br207293)クラス |
...
| **System.Net.Sockets.UdpAnySourceMulticastClient**、**UdpSingleSourceMulticastClient** クラス | [**マッピングされています**](https://msdn.microsoft.com/library/windows/apps/br241319)クラス |
...
| シェル | |
| (MPSh = **Microsoft.Phone.Shell**) <br/> **MPSh.ApplicationBar** クラス | [**コマンド バー** ](https://msdn.microsoft.com/library/windows/apps/dn279427)クラス |
| (MPSh = **Microsoft.Phone.Shell**) <br/> **MPSh.ApplicationBarIconButton** クラス | [**AppBarButton** ](https://msdn.microsoft.com/library/windows/apps/dn279244)クラス (内部で使用すると、 [ **PrimaryCommands** ](https://msdn.microsoft.com/library/windows/apps/dn279430)プロパティ) |
| (MPSh = **Microsoft.Phone.Shell**) <br/> **MPSh.ApplicationBarMenuItem** クラス | [**AppBarButton** ](https://msdn.microsoft.com/library/windows/apps/dn279244)クラス (内部で使用すると、 [ **SecondaryCommands** ](https://msdn.microsoft.com/library/windows/apps/dn279434)プロパティ) |
...
| **System.IO.File** クラス | [**StorageFile** ](https://msdn.microsoft.com/library/windows/apps/br227171)と[ **PathIO** ](https://msdn.microsoft.com/library/windows/apps/hh701663)クラス

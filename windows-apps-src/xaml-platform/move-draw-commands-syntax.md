...
Blend for Microsoft Visual Studio2015**ペン**ツールやその他の描画ツールを使用して、通常と移動の[**パス**](/uwp/api/Windows.UI.Xaml.Shapes.Path)のオブジェクトを生成し、描画のコマンド。

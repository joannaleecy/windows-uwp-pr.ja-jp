...
2.  最新の Windows 10 SDK をインストールします。 これは [https://developer.microsoft.com/en-US/windows/downloads/windows-10-sdk](https://developer.microsoft.com/en-US/windows/downloads/windows-10-sdk) から入手できます。

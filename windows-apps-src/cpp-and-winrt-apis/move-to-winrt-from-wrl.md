...
**IUnknown**へのポインターを想定している関数には基になる生のポインターを渡す場合は、次の例に示す[**winrt::get_unknown**](/uwp/cpp-ref-for-winrt/windows-foundation-iunknown#getunknown-function)自由関数でを使用します。

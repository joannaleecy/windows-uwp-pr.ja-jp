...
**IUnknown**へのポインターを想定している関数に基になる生のポインターを渡す場合は、次の例に示すように、 [**winrt::get_unknown**](/uwp/cpp-ref-for-winrt/windows-foundation-iunknown#getunknown-function)自由関数を使用します。

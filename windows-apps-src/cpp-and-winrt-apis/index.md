...
| [C++ し、強固で弱参照/WinRT](weak-references.md) | Windows ランタイムは、参照カウント システムです。知っておくは、重要性とを区別する重要なシステムで強力なと弱参照します。 |
...
| トピック | 説明 |
| - | - |
| [値のカテゴリとへの参照](cpp-value-categories.md) | このトピックでは、C++ での値のさまざまなカテゴリについて説明します。 左辺値と rvalue の音が間違いが、その他の種類すぎます。 |

...
<span data-ttu-id="a5e7b-115">すべてのデータ バインディングには、次の 2 つの部分があります。</span><span class="sxs-lookup"><span data-stu-id="a5e7b-115">Every data binding has two pieces:</span></span>

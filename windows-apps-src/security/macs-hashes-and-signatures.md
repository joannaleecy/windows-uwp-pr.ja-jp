...
-   <span data-ttu-id="1bf1f-111">ボブとアリスは秘密鍵を共有し、MAC 関数を使うことに同意しています。</span><span class="sxs-lookup"><span data-stu-id="1bf1f-111">Bob and Alice share a secret key and agree on a MAC function to use.</span></span>

...
<span data-ttu-id="ecb0a-136">PIN のリセットを要求するには、次の手順に従います。</span><span class="sxs-lookup"><span data-stu-id="ecb0a-136">To request a PIN reset:</span></span>

...
> **注**  ここで提供される情報がいくつかのガイダンスを提供しますが、アプリ開発者が、アプリがすべて適用される法律および規制に準拠しているかどうかを確認する Microsoft Store でアプリを発行する必要があります。
...
> **重要な**  だけでなく、アプリもすべてのソフトウェア ライブラリ、ユーティリティ、およびアプリを追加またはにリンクするオペレーティング システムのコンポーネント用に作成したコードを検討してください。

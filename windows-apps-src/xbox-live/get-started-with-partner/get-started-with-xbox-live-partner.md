...
利用可能なコンテンツだけでなくここでは、あるも承認済みのパートナー センター アカウントでパートナーに提供されるその他のドキュメント。 ここでそのコンテンツにアクセスできます。[パートナー コンテンツの Xbox Live](https://developer.microsoft.com/en-us/games/xbox/docs/xboxlive/xbox-live-partners/partner-content)します。
...
## <a name="1-choose-a-platform"></a>1. プラットフォームを選択します。
...
サインインし、Xbox Live サービスを呼び出すことができます前に、パートナー センターまたは Xbox 開発者ポータル (XDP) ですべての Xbox Live のタイトルを定義する必要があります。  これを行う方法は、「[新しいタイトルの作成](create-a-new-title.md)」で説明します。

## <a name="3-follow-the-appropriate-guide-to-setup-your-ide-or-game-engine"></a>3.IDE、ゲーム エンジンを設定する適切なガイドに従ってください。
プラットフォームやエンジンに関する適切なファースト ステップ ガイドに従い、それに沿って学習することで、Xbox Live の基本を習得することができます。

* [Visual Studio の UWP ゲームの使用を開始](get-started-with-visual-studio-and-uwp.md)はパートナー センターで、Xbox Live の構成と、Visual Studio プロジェクトをリンクする方法を説明します。
...
- [Xbox Live のサンド ボックス](../xbox-live-sandboxes.md)
- [テスト アカウントの Xbox Live](../xbox-live-test-accounts.md)
- [Xbox Live Api の概要](../introduction-to-xbox-live-apis.md)

## <a name="5-add-xbox-live-features"></a>5。Xbox Live 機能を追加します。
...
- [Xbox Live マルチプレイヤー プラットフォーム - 招待をマッチメイ キング、トーナメント](../multiplayer/multiplayer-intro.md)
...
## <a name="6-release-your-title"></a>6。リリースのタイトル

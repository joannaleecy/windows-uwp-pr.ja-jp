...
3.  Visual Studio で、ユニバーサル Windows アプリ プロジェクトに Xbox Live サポートを追加します。 完全なソースを追加することも、Visual Studio 2015 プロジェクトに NuGet パッケージをインストールしてバイナリを参照することもできます。 C++ と WinRT の両方にパッケージが提供されています。 詳細については、「[新規または既存の UWP プロジェクトに Xbox Live を追加する方法](../get-started-with-partner/get-started-with-visual-studio-and-uwp.md)」を参照してください
...
<table>
  ...
  <tr>
    ...
    <td>Microsoft::Xbox::Services (*変更なし*)</td>

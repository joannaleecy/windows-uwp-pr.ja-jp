...
---
# <a name="configure-xbox-live-setup-in-partner-center"></a>パートナー センターの Xbox Live の設定を構成します。

使用することができます[パートナー センター](https://developer.microsoft.com/dashboard) Xbox Live、ゲームに関連付けられているプロパティの初期セットを構成します。 次の手順に従って、構成を追加します。
...
このドロップダウン メニューでは、製品の種類を変更できます。 既定値は、種類 **[ゲーム]** です。 Xbox Live 機能を使用する選択した内容に影響します。 次の 3 つのオプションから選択できます。
1. App 
2. Game 
3. ゲームの体験版 
...
## <a name="advanced-settings"></a>Advanced settings (詳細設定)

...
> **注:** Xbox 開発者キット (XDK) を使用している場合、*新機能 - 2016 年 4 月*取り上げて XDK 年 3 月リリース以降に追加された新しい機能を追加します。
...
> **注:** ソーシャル マネージャーやマルチ プレーヤー マネージャーは、タイトルでこれらの機能を使用する場合、1 つの結合された websocket を使用します。

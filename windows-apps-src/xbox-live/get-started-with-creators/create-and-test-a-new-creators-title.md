...
既定では、パートナー センター アカウントに追加したすべての Xbox One 開発コンソールは開発サンド ボックスへのアクセスがあります。  Xbox One 本体を追加するには、[Xbox One 本体の管理のページ](https://partner.microsoft.com/XboxDevices)に移動します。 既にパートナー センター アカウントになっている場合は、**アカウントの設定**に移動できます > **アカウントの設定** > **デベロッパー デバイス** > **Xbox One 開発機本体**です。

...
---
# <a name="uri"></a>/{uri}
ゲーム クリップ データにアクセスします。 これらの Uri のドメイン`gameclipsmetadata.xboxlive.com`と`gameclipstransfer.xboxlive.com`に対象の URI の機能に依存します。
...
| パラメーター| 型| 説明| 
| --- | --- | --- | 
| <b>uri</b>| string| 使用する URI です。 詳細については、メソッドのページを参照してください。| 

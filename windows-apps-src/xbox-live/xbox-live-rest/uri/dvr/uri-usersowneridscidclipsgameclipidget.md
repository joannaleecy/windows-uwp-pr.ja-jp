...
> [!NOTE] 
> URI 更新は、最大 30 ~ 40 秒この要求が完了したらにかかることができます。 URI の有効期限が切れた場合しようとするとすぐにストリーミング操作の使用すると、IIS スムーズ ストリーミング サーバーから HTTP 500 ステータス コードが取得します。 これを短縮する方法に取り組んでいて、この注がその作業の進行に応じて更新されます。 

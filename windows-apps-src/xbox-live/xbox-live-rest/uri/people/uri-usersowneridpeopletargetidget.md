...
呼び出し元のユーザーのコレクションからターゲット ID によって、ユーザーを取得します。 これらの Uri のドメインが`social.xboxlive.com`します。
...
| 404| Not Found します。| 対象ユーザーが所有者のユーザー リストで見つかりませんでした。| 
...
呼び出しが成功した場合、サービスは、対象のユーザーを返します。 [ユーザー (JSON)](../../json/json-person.md)を参照してください。

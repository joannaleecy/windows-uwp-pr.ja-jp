...
POST ので、これは、同じ結果に 1 回または複数回実行している場合、操作はすべてのリソースを変更しません。
...
| コード| 理由フレーズ| 説明| 
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | 
| 200| OK| メソッドが「取得」は成功します。| 
| 204| No Content| 成功メソッドが「追加」または「削除」します。| 
| 400| Bad Request| メソッドのパラメーターが不足しているか、形式が正しくない、またはユーザー Id が正しくありません。| 
...
応答本文は要求メソッドが「取得」の場合にのみ送信されます。 「追加」または「削除」の応答の本文はありません。

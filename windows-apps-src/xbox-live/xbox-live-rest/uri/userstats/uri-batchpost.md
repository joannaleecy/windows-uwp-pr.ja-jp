...
詳しくは、検索がする前に[GET](uri-usersxuidscidsscidstatsget.md)メソッド読み取りより複雑なこのバッチ モード ページ、簡単なシングル統計情報を確認すると便利です。
...
次の POST 本文は、2 人のユーザーの 2 つの異なる Scid から 4 つの統計情報が要求されていることをサービスに通知します。

...
---
# <a name="delete-untrustedplatformusersxuidxuidscidssciddatapathandfilenametype"></a>削除 (/untrustedplatform/users/xuid({xuid})/scids/{scid}/data/{pathAndFileName},{type})

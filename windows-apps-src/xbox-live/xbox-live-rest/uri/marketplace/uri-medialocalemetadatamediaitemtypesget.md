...
---
# <a name="get-mediamarketplaceidmetadatamediaitemtypes"></a>(/Media/{marketplaceId} メタデータ/mediaItemTypes) を取得します。
指定した EDS バージョンのサポートされているすべての mediaItemTypes の一覧を示します。 これらの Uri のドメインが`eds.xboxlive.com`します。

...
---
# <a name="mediamarketplaceidmetadatamediagroups"></a>メタデータ/mediaGroups/media/{marketplaceId}
...
[(/Media/{marketplaceId} メタデータ/mediaGroups) を取得します。](uri-medialocalemetadatamediagroupsget.md)

...
いくつかの異なるメディア グループからアクセス項目。 これらの Uri のドメインが`eds.xboxlive.com`します。
...
[取得する (/media/{marketplaceId}/crossMediaGroupSearch)](uri-localecrossmediagroupsearchget.md)

&nbsp;&nbsp;いくつかの異なるメディア グループから項目を取得します。

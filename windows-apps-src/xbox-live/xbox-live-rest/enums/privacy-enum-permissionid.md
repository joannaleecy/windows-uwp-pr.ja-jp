...
アクセス許可の検証の Url とアクセス許可の Id を使用できます。
   ...
   * [取得する (アクセス許可が/users/{requestorId}/検証)](../uri/privacy/uri-privacyusersrequestoridpermissionvalidateget.md)
   * [POST (アクセス許可が/users/{requestorId}/検証)](../uri/privacy/uri-privacyusersrequestoridpermissionvalidatepost.md)
...
| ViewTargetExerciseInfo| 対象ユーザーの演習情報に表示するかどうかを確認します。|

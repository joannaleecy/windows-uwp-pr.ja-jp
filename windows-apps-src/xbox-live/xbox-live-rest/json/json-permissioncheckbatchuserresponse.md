...
| アクセス許可| [PermissionCheckResponse (JSON)](json-permissioncheckresponse.md)の配列| 必須。 各要求と同じ順序で、元の要求で要求されたアクセス許可の[PermissionCheckResponse (JSON)](json-permissioncheckresponse.md) 。| 

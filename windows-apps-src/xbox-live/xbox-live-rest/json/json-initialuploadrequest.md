...
| メンバー| 種類| 説明| 
| --- | --- | --- | 
| <b>greatestMomentId</b>| string| 文字列は、テキストのクリップの名として使用する ID。 これの管理し、タイトルの開発者によってタイトルの構成ファイル内のローカライズされました。| 
| <b>userCaption</b>| string| 省略可能。 ユーザーが入力したの代替名最大 250 文字の最大長のゲーム クリップされます。| 

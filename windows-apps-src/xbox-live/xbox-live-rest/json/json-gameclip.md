...
| <b>状態</b>| GameClipState| システムでのゲーム クリップの状態。| 
| <b>dateRecorded</b>| DateTime| 日付と UTC (ISO 8601 形式) で、レコーディングが開始された時刻。| 
| <b>lastModified</b>| DateTime| 最終ゲーム クリップまたは UTC (ISO 8601 形式) で、メタデータの時間を変更します。| 
| <b>userCaption</b>| string| ユーザーが入力したローカライズされていない用の文字列は、ゲーム クリップされます。| 
| <b>type</b>| GameClipTypes| クリップの種類です。 その場合をコンマで区切られたことが、複数の値ができます。| 
| <b>ソース</b>| GameClipSource| どのクリップも供給されました。| 
| <b>visibility</b>| GameClipVisibility| システムが公開されると、ゲーム クリップの可視性です。| 
| <b>durationInSeconds</b>| 32 ビットの符号なし整数| 秒単位でゲーム クリップの再生時間。| 
| <b>scid</b>| string| ゲームのクリップが関連付けられている SCID です。| 
| <b>rating</b>| 倍精度浮動小数点数| 0.0 に 5.0 の範囲で、ゲーム クリップに関連付けられている評価です。| 

...
## [実績 URI](uri/achievements/atoc-reference-achievementsv2.md)
...
## [ゲーム サーバー URI](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [ゲーム DVR URI](uri/dvr/atoc-reference-dvr.md)
...
## [リスト URI](uri/lists/atoc-reference-lists.md)
...
## [マッチメイキング URI](uri/matchtickets/atoc-reference-matchtickets.md)
...
## [People URI](uri/people/atoc-reference-people.md)
...
## [プレゼンス URI](uri/presence/atoc-reference-presence.md)
...
## [プライバシー URI](uri/privacy/atoc-reference-privacyv2.md)
...
## [プロフィール URI](uri/profileV2/atoc-reference-profiles.md)
...
## [評判 URI](uri/reputation/atoc-reference-reputation.md)
...
## [セッション ディレクトリ URI](uri/sessiondirectory/atoc-reference-sessiondirectory.md)
...
## [実績タイトル履歴 URI](uri/titlehistory/atoc-reference-titlehistoryv2.md)
...
## [タイトル ストレージ URI](uri/storage/atoc-reference-storagev2.md)
...
## [システム文字列の検証 URI](uri/stringserver/atoc-reference-systemstringsvalidate.md)
...
## [ユーザー URI](uri/users/atoc-reference-users.md)
...
## [ユーザー統計 URI](uri/userstats/atoc-reference-userstats.md)
...
## [GameClipSource 列挙型](enums/gvr-enum-gameclipsource.md)
## [GameClipState 列挙型](enums/gvr-enum-gameclipstate.md)
## [GameClipType 列挙型](enums/gvr-enum-gamecliptypes.md)
## [GameClipUriType 列挙型](enums/gvr-enum-gameclipuritype.md)
## [GameClipVisibility 列挙型](enums/gvr-enum-gameclipvisibility.md)
## [ThumbnailSource 列挙型](enums/gvr-enum-thumbnailsource.md)
## [ThumbnailType 列挙型](enums/gvr-enum-thumbnailtype.md)
## [PermissionId 列挙型](enums/privacy-enum-permissionid.md)
# [その他の参照情報](additional/atoc-xboxlivews-reference-additional.md)
## [承認のタイプ](additional/authorizationtypes.md)
## [データ型の概要](additional/datatypeoverview.md)
## [EDS の補助 API](additional/eds-apis.md)
## [EDS 承認](additional/edsauthorization.md)
## [EDS 共通ヘッダー](additional/edscommonheaders.md)
## [EDS パラメーター](additional/edsparameters.md)
## [EDS クエリの絞り込み条件](additional/edsqueryrefiners.md)
## [ビデオの EDS 逆引き参照](additional/edsreverselookup.md)
## [EDS の表](additional/edstables.md)
## [ページング パラメーター](additional/pagingparameters.md)
## [標準の HTTP 要求および応答ヘッダー](additional/httpstandardheaders.md)
## [標準の HTTP 状態コード](additional/httpstatuscodes.md)

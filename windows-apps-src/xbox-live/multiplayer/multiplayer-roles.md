...
一部のゲーム セッションでは、特定のメンバーが特定のゲームプレイの役割 (サポート、medic、暴力など) にあることを指定します。Wat ゲームプレイの特定のロールによって設定されるプレーヤーのゲームのスロットを予約することもできます。 Xbox Live のロール機能を使用することで、サービスはプレイヤーに対するゲームプレイ ロールの割り当てを追跡し、特定のゲームプレイ ロールを選択できるプレイヤーの最大数を設定することができます。
...
> **概要**Xbox Live SDK 現在のみのサポートを 1 つのロールの種類とメンバーごとに 1 つのロール。

...
7.  MPSD へ」の説明に従って、セッションのようになりました書き込み**方法。マルチ プレーヤーのセッションを更新**します。
...
4.  ローカルの変更が完了したら、それに書き込む MPSD」の説明に従って**方法。マルチ プレーヤーのセッションを更新**します。
...
5.  」の説明に従って、MPSD でセッションを更新**方法。マルチ プレーヤーのセッションを更新**します。
...
2.  タイトルのアクティベーション時にセッションを開始し、セッションの変更通知をサブスクライブします。 参照してください**方法。MPSD セッションの変更通知のサブスクライブ**します。
3.  ユーザーをアクティブとしてセッションに参加させます。 参照してください**方法。タイトルのライセンス認証から MPSD セッションに参加**します。
4.  ロビー セッションを、プロフィール UI を通じて公開されるアクティビティ セッションとして設定します。 参照してください**方法。ユーザーの現在のアクティビティを設定**します。
...
2.  ユーザーをアクティブとしてセッションに参加させます。 参照してください**方法。タイトルのライセンス認証から MPSD セッションに参加**します。
...
7.  セッションをアクティブなセッションとして設定します。 参照してください**方法。ユーザーの現在のアクティビティを設定**します。
...
1.  招待側プレイヤーを参加可能にします。 参照してください**方法。ように、ユーザーが結合可能な**します。
...
6.  リモート プレイヤーのために、タイトルのアクティベーション コードを実装します。 参照してください**方法。タイトルのライセンス認証管理**します。
...
タイトルのアクティブ化によって、ユーザーの現在のアクティビティを設定するを参照してください。**方法。タイトルのライセンス認証から MPSD セッションに参加**します。
...
2.  」の説明に従って、MPSD でゲーム セッションを更新**方法。マルチ プレーヤーのセッションを更新**します。
...
5.  セッションがまだ完全なしない場合は、」の説明に従って一致チケットの作成**方法。一致のチケットを作成**です。 チケットを作成するには必ず *preserveSession* パラメーターを Always に設定します。

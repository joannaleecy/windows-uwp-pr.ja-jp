...
<span data-ttu-id="4ec7e-105">次のフローチャートでは、ゲームへの招待に応答する場合、またはメンバーのプロフィール カードを通してゲームに参加する場合のフローを示します。</span><span class="sxs-lookup"><span data-stu-id="4ec7e-105">The following flowcharts show the flow of responding to a game invite, or joining a game via the member's profile card.</span></span>

## <a name="handle-protocol-activation"></a><span data-ttu-id="4ec7e-106">プロトコルのアクティブ化を処理する</span><span class="sxs-lookup"><span data-stu-id="4ec7e-106">Handle protocol activation</span></span>

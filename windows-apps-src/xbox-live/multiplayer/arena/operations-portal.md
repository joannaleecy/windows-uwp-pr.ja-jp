...
Xbox アリーナ操作ポータルを作成および Xbox アリーナと統合されているタイトルのトーナメントを公式を管理できます。 公式のトーナメントでは、タイトルによって実行され、開発者はよりカスタマイズ機能と管理のトーナメントを作成したユーザーを許可します。
...
* Prizing フラグ (トーナメントが、受賞歴のある用を報いるプレイヤーに示すアイコン) と使用の位トーナメントの条件を設定します。

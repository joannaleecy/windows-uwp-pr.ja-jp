...
| グローバル             | 256 MB | 256 MB            | ロスター、マップ、チャレンジ、アート リソースなど、だれでも読み取ることができるデータ。 | のみ Xbox デベロッパー ポータルまたは Windows デベロッパー センター経由で書き込み可能なすべてのプラットフォームが読み取れます。                                | すべてのユーザーが読み取れます。

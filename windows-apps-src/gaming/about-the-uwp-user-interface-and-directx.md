...
[**CoreWindow** ](https://msdn.microsoft.com/library/windows/apps/br208225)イベントの数を入力し、基本的な特定のウィンドウの動作を提供します。 これらのイベントを処理するには、イベントに自分専用のデリゲートを登録します。

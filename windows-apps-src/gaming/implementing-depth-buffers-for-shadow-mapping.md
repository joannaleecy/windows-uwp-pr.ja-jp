...
<tbody>
<tr class="odd">
<td align="left"><p>[深度バッファーのデバイス リソースの作成](create-depth-buffer-resource--view--and-sampler-state.md)</p></td>
<td align="left"><p>シャドウ ボリュームの深度のテストをサポートするために必要な Direct3D デバイス リソースを作成する方法について説明します。</p></td>
</tr>
<tr class="even">
<td align="left"><p>[深度バッファーへのシャドウ マップのレンダリング](render-the-shadow-map-to-the-depth-buffer.md)</p></td>
<td align="left"><p>ライトの視点からレンダリングして、シャドウ ボリュームを表す 2 次元の深度マップを作成します。</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[深度のテストを使ったシーンのレンダリング](render-the-scene-with-depth-testing.md)</p></td>
<td align="left"><p>シャドウ効果を作成するには、頂点 (またはジオメトリ) シェーダーとピクセル シェーダーに深度のテストを追加します。</p></td>
</tr>
<tr class="even">
<td align="left"><p>[ハードウェアの範囲でのシャドウ マップのサポート](target-a-range-of-hardware.md)</p></td>

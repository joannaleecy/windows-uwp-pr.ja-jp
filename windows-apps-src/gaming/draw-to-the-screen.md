...
<span data-ttu-id="0417f-125">テンプレートのレンダラー オブジェクトには次のフィールドがあります。</span><span class="sxs-lookup"><span data-stu-id="0417f-125">In the template, the renderer object contains the following fields:</span></span>

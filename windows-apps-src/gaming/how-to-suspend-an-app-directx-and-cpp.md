...
## <a name="save-any-app-data-before-suspending"></a><span data-ttu-id="16e43-109">一時停止の前に任意のアプリ データを保存する</span><span class="sxs-lookup"><span data-stu-id="16e43-109">Save any app data before suspending</span></span>

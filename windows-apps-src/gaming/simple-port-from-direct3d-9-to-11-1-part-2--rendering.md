...
> **注:** をピクセル シェーダーに頂点シェーダーをバインドの direct3d9 の規則 direct3d11 の規則よりも緩やかでした。 Direct3D 9 の配置は、柔軟ですが、効率的ではありませんでした。
...
> **注:** 定数バッファーは、一度に 4 つの浮動小数点数にアラインメントする固定の入力レイアウトを使用します。 定数バッファー データには [**XMFLOAT4**

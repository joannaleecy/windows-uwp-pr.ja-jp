...
Windows デベロッパー センター ダッシュボードの **[広告キャンペーン]** レポートでは、アプリ プロモーション広告キャンペーンの実施状況を確認できます。

このレポートを表示するには、左側のナビゲーション メニューで、**[ユーザーへのアピール]** を展開し、**[広告キャンペーン]** を選ぶか、**[収益化]** を展開して **[アプリの宣伝]** を選びます。 

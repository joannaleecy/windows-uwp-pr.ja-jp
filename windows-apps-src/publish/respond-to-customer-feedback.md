...
[パートナー センター](https://partner.microsoft.com/dashboard)アプリに関するフィードバックを提供したお客様に対応するための 3 つのオプションをサポートしています。 いずれの方法を選択した場合も、1 回の返信につき 1000 文字の文字数制限があるので注意してください。
...
- **調査**:問題のことを知っているし、そこに表示されています。
- **作業**:問題を修正するか、要求された機能を追加します。
- **完了した**:この問題を解決または要求された機能を追加する更新プログラムを公開しました。

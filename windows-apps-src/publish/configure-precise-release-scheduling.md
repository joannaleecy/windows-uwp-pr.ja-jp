...
>
>以前に公開されたアプリで選択した**購入の停止**日付以前の OS バージョンをサポートしている場合は、これらのユーザーには適用されません。([可視性](choose-visibility-options.md#discoverability)」セクションで新しい選択で更新プログラムを提出する場合を除き、または**アプリが使用できないように****アプリの概要**ページから選択した場合など) にアプリを入手することがあります。

...
プロモーションやエンゲージメントの目的で、ユーザー ベースのサブセットをターゲットに設定する場合があります。 これを行うことができます[パートナー センター](https://partner.microsoft.com/dashboard)の種類を作成して[顧客グループ](create-customer-groups.md)と呼ばれる、*セグメント*人口統計を満たしている Windows 10 の顧客が含まれますか選択した収益条件。
...
1.  [パートナー センター](https://partner.microsoft.com/dashboard)、展開**エンゲージ**を選択し、左側のナビゲーション メニューで**顧客グループ**します。
...
5.  **[包含条件の定義]** セクションで、セグメントのフィルター条件を指定します。
    ...
    フィルター条件などのさまざまなことができます**買収**、**買収ソース**、 **Demographic**、**評価**、**チャーン予測**、**購入を格納**、**格納買収**と**ストアを費やす**。

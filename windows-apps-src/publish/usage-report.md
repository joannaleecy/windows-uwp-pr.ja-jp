...
[パートナー センター](https://partner.microsoft.com/dashboard)での**利用状況**レポートでは、Windows 10 (Xbox を含む) のユーザーにアプリを使用している方法を確認でき、定義したカスタム イベントに関する情報を表示します。 パートナー中央揃え、または[レポートをダウンロード](download-analytic-reports.md)してオフラインでは、このデータを表示できます。

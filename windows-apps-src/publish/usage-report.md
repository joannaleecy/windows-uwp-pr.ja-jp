...
**30 D**の期間を選択すると、**ユーザー**、**デバイス**、または**期間**のタブを表示するときに円形のマーカーが表示されます。 これらは大幅に増加または減少する特定の値を知りたいと考えること。 円を表示する日付は、大幅に増加または減少の前に、その週との比較を検出しました週の終わりを表します。 変更についての詳細を表示するには、円の上に置きます。  

> [!TIP]
> [分析レポート](insights-report.md)の最後の 30 日間の大幅な変更に関連する他の情報を表示することができます。

...
3. **[テンプレートの選択**] セクションで**送信する**[通知の種類](#notification-template-types)を選択します。
...
2.  、既にある通知のテーブルでは、**進行中**] または [ **Completed**を選択し、通知ごとの大まかなパフォーマンスを確認する**配信率**と**アプリの起動率**の列を確認します。

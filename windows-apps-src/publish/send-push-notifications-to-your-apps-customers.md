...
[パートナー センター](https://partner.microsoft.com/dashboard)は、データ ドリブンを提供するには、すべてのアプリのユーザーに通知を送信を使用する場合、または[顧客で定義した条件を満たす、アプリの Windows 10 ユーザーのサブセットだけを対象の顧客エンゲージメント プラットフォームセグメント](create-customer-segments.md)します。 アプリの 1 つ以上の顧客に送信される通知を作成することもできます。
...
1.  パートナー センターでは、**利用率の引き上げ**] セクションを展開し、**通知**を選択します。
...
3. ページの上部で、データを表示する期間を選択できます。 既定では [30 日間] が選択されていますが、3、6、12 か月間のデータや、指定した任意の期間のデータを表示することもできます。 すべてのアプリと市場でデータをフィルター処理するための**フィルター**を展開することもできます。

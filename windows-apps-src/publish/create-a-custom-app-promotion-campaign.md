...
アプリのカスタム キャンペーンを実行する場合、カスタム キャンペーンごとに異なる*キャンペーン ID* を含んだ異なる URL を作成することによって、各キャンペーンの相対的な成果を追跡できます。 Windows 10 を実行しているお客様は、キャンペーン ID が含まれている URL をクリックすると、Microsoft 関連付けます対応するカスタム キャンペーンをクリックし、このデータ利用可能なに[パートナー センター](https://partner.microsoft.com/dashboard)でします。

> [!IMPORTANT]
> このデータは、windows 10 のユーザーについてのみ追跡します。 他のオペレーティング システムを使用しているユーザーも、アプリの内容へのリンクをたどることはできますが、それらのユーザーの活動に関するデータは含まれません。
...
* [取得レポート](acquisitions-report.md)では、ページ ビューと**アプリ ページ ビューとキャンペーン ID ごとのコンバージョン**と**キャンペーンのコンバージョン合計**グラフから、アプリやアドオンのコンバージョンに関するデータを表示できます。
...
カスタム キャンペーンの*コンバージョン*とは、カスタム キャンペーンによって宣伝された URL をクリックしたユーザーが、結果としてアプリを取得することです。 [コンバージョンと認められる条件と、**アプリ ページ ビューとキャンペーン ID ごとのコンバージョン**および**キャンペーンのコンバージョン合計**グラフの[取得] レポート](acquisitions-report.md)でコンバージョンと認められる条件をさまざまなシナリオがあります。プログラムによってキャンペーン ID を取得](#programmatically)します。

### <a name="qualifying-conversions-in-the-acquisitions-report"></a>[取得] レポートでコンバージョンと認められる条件
...
4. 予想されたページ ビューとコンバージョンの[取得] レポート](acquisitions-report.md)では、**キャンペーンのコンバージョン合計**と**アプリ ページ ビューとコンバージョン キャンペーン ID ごと**のグラフに表示され、ことができるかどうかを確認するアプリのコードをテストするかどうかを確認します。上記で説明した Api を使用してキャンペーン ID を正常に取得します。

...
4. 予想されたページ ビューとコンバージョンの[取得] レポート](acquisitions-report.md)では、**キャンペーンのコンバージョン合計**と**アプリ ページ ビューとコンバージョン キャンペーン ID ごと**のグラフに表示され、できるかどうかを確認する、アプリのコードをテストするかどうかを確認します。上記で説明した Api を使用してキャンペーン ID が正常に取得します。

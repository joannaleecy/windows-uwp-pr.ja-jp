...
アプリのカスタム キャンペーンを実行する場合、カスタム キャンペーンごとに異なる*キャンペーン ID* を含んだ異なる URL を作成することによって、各キャンペーンの相対的な成果を追跡できます。 Windows 10 を実行している顧客は、キャンペーン ID が含まれている URL をクリックすると、Microsoft、クリックに対応するカスタム キャンペーンを関連付け、このデータを利用可能なに[パートナー センター](https://partner.microsoft.com/dashboard)で。

...
([**アカウントの設定**)、Windows デベロッパー センターの [**ユーザー** ] セクションでは、ユーザーをデベロッパー センター アカウントに追加する Azure Active Directory を使用できます。 各ユーザーには、アカウントへのアクセスを定義するロール (またはカスタムのアクセス許可のセット) が割り当てられます。 また、[ユーザーのグループ](#groups)や [Azure AD アプリケーション](#azure-ad-applications)を追加して、デベロッパー センターへのアクセスを許可することもできます。
...
1.  (ダッシュ ボードの上部の右上隅) 近くにある歯車アイコンを選択し、**アカウントの設定**を選択します。 **Settings** ] メニューでは、**ユーザー**を選択します。
...
-   **既存のユーザーの追加**: 既に組織のディレクトリに存在してアクセス権を付与して、デベロッパー センター アカウントに上記の方法を使用してユーザーを選択します。
-   **新しいユーザーを作成**します両方の組織のディレクトリを追加する新しいユーザー アカウントと、デベロッパー センター アカウントの作成。
...
1.  ([**アカウントの設定**)**ユーザー**ページで、**追加のグループ**をクリックします。
...
1.  1.  (ダッシュ ボードの上部の右上隅) 近くにある歯車アイコンを選択し、**アカウントの設定**を選択します。 **Settings** ] メニューでは、**ユーザー**を選択します。

...
ms.prod: windows
ms.technology: uwp
keywords: windows 10、uwp、azure ad アプリケーション、aad、ユーザー、グループ、複数のユーザー、複数のユーザー
...
([**アカウントの設定**)] で、Windows デベロッパー センターの [**ユーザー** ] セクションでは、Azure Active Directory を使用して、デベロッパー センター アカウントにユーザーを追加することができます。 各ユーザーには、アカウントへのアクセスを定義するロール (またはカスタムのアクセス許可のセット) が割り当てられます。 また、[ユーザーのグループ](#groups)や [Azure AD アプリケーション](#azure-ad-applications)を追加して、デベロッパー センターへのアクセスを許可することもできます。
...
1.  ([ダッシュ ボードの上部の右下隅) にある歯車アイコンをクリックし、[**アカウント設定**] を選択します。 [**設定**] メニューで、**ユーザー**を選択します。
...
-   **既存のユーザーの追加**: 既に組織のディレクトリ内に存在し、それらにアクセスできるように、デベロッパー センター アカウントでは、上記の方法を使用してユーザーを選択します。
-   **新しいユーザーを作成する**: 初めてのユーザー アカウントに両方の組織のディレクトリを追加して、デベロッパー センター アカウントを作成します。
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、**ユーザーの追加**] を選択し、**新しいユーザーの作成**] を選びます。
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、**ユーザーの追加**] を選択し、[**電子メールでユーザーを招待**] を選びます。
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、編集するユーザー アカウントの名前を選択します。
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、[**グループの追加**] をクリックします。
...
1.  1.  ([ダッシュ ボードの上部の右下隅) にある歯車アイコンをクリックし、[**アカウント設定**] を選択します。 [**設定**] メニューで、**ユーザー**を選択します。
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、 **Azure AD アプリケーションを追加する**] を選びます。
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、Azure AD アプリケーションの名前を選択します。
    > [!TIP]
...
1.  ([**アカウントの設定**)] で [**ユーザー** ] ページで、ユーザー、グループ、または編集する Azure AD アプリケーションのアカウントの名前を選択します。
...
([**アカウントの設定**)] で [**ユーザー** ] ページで、ユーザーが閲覧の履歴を確認するには、**最後のアクティビティ**の下に表示するリンクを選択します。 ユーザーが過去 30 日間にアクセスしたすべてのページの URL を参照できます。

<span id="remove" />

## <a name="remove-users-groups-and-azure-ad-applications"></a>ユーザー、グループ、および Azure AD アプリケーションの削除

デベロッパー センター アカウントから、ユーザー、グループ、または Azure AD アプリケーションを削除するには、**ユーザー**ページで、相手の名前が表示される**を削除する**リンクを選択します。 削除を確認した後は、そのユーザー、グループ、または Azure AD アプリケーションは、デベロッパー センター アカウントにアクセスできなくなります (後で追加する場合を除く)。

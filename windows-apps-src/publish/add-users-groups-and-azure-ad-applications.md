...
1.  **ユーザー**ページ ([**アカウントの設定**) では、**ユーザーの追加**を選択し、**新しいユーザーの作成**を選択します。
...
([**アカウントの設定**)**のユーザー** ] ページで、ユーザーが閲覧の履歴を確認するには**前回のアクティビティ**下に表示されるリンクを選択します。 ユーザーが過去 30 日間にアクセスしたすべてのページの URL を参照できます。

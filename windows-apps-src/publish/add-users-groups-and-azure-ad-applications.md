...
1.  (右上隅のパートナー センター) 近くにある歯車アイコンを選択し、**開発者向け設定**] を選択します。 **設定**メニューで、**ユーザー**を選択します。
...
-   **新しいユーザーの作成**: 両方の組織のディレクトリを追加する新しいユーザー アカウントとパートナー センターのアカウントの作成
...
ユーザー アカウントの作成時に **[パスワードの回復メール]** を設定しておくと、そのユーザーは、パスワードを変更する必要がある場合に自分で処理できます。 ユーザーのパスワードは、以下の手順に従って更新することもできます (ユーザーのパスワードを変更するには、Azure AD テナントに対して全体管理者アカウントでサインインしている必要があります)。 これは Azure AD テナント内のユーザーのパスワードを変更、パートナー センターにアクセスすると共に、パスワードを使用することに注意してください。 
...
1.  1.  (右上隅のパートナー センター) 近くにある歯車アイコンを選択し、**開発者向け設定**] を選択します。 **設定**メニューで、**ユーザー**を選択します。
...
ユーザー、グループ、および Azure AD アプリケーションをパートナー センター アカウントを追加した後、アカウント情報を変更をすることができます。 
...
ユーザー、グループ、または Azure AD アプリケーション パートナー センターのアカウントからを削除するには、**ユーザー**のページで名前の横に表示される**を削除する**リンクを選択します。 それを削除することを確認すた後には、そのユーザー、グループ、または Azure AD アプリケーションしなくなる (追加しないと、その後でもう一度)、パートナー センター アカウントにアクセスできません。

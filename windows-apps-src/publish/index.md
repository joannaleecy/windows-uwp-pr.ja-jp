...
<p><a href="https://partner.microsoft.com/dashboard">パートナー センター</a>を使用することで、アプリとゲームを Microsoft Store に公開できます。 <a href="https://developer.microsoft.com/store/register">今すぐサインアップしましょう。</a></p>

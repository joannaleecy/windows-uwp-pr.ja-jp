...
提出の更新を公開するときには、Windows 10 で特定の割合のアプリ ユーザーに対して、更新されたパッケージを段階的にロール アウトすることを選択できます。 これにより、更新に確信が持てるよう、特定のパッケージのフィードバックと分析データを監視してから、より広くロールアウトできます。 この割合は、新しい申請を作成することなく、いつでも増やす (または更新を停止する) ことができます。 

---
Description: Microsoft Store は、世界中の 200 以上の国と地域のお客様が利用できます。
title: 市場の選択の定義
...
> [!IMPORTANT]
> ここで、またはパートナー センターで、それらの要件が記載されていない場合でも、法的要件を満たすために必要になります。
...
> [!NOTE]
> Windows 8 または Windows 8.1 を対象とするパッケージを含む公開されていたアプリ、いくつか個々 の市場は、1 つの"World Rest"市場を 1 つとして扱われます。 詳しくは、「[Windows 8.x の "その他の国と地域" 市場](#rest-of-world-markets-for-windows-8x)」をご覧ください。
...
## <a name="microsoft-store-consumer-markets"></a>Microsoft Store コンシューマー市場

以下に挙げる市場の中から、アプリ (またはアドオン) を公開する市場を 1 つ以上選ぶことができます。 アスタリスクが付いて市場; Xbox One での Microsoft Store のサポートします。わかります**Xbox**その名前の横に、**市場の選択**ポップアップ ウィンドウ。
...
かどうか、以前に発行アプリには、Windows を対象とするパッケージが含まれます 8.x がさまざまな市場が単一"Rest の World"マーケットで Windows ストアを使用して顧客として扱われることに注意してくださいに重要ですが、個々 の市場として表示される場合でも、8.xパートナー センター。

アプリを送信するときに、既定の市場の選択をままにした場合、これについて心配する必要はなく、アプリが可能なすべての市場に提供されます。 ただし、特定の市場を除外する場合は、保持に注意してくださいを除くこれら"World Rest"市場手段で使用できることなく、アプリがの 1 つでも*任意*"Rest の世界の"Windows 8 または Windows 8.1 上で顧客の市場です。

...
1.  [パートナー センター](https://partner.microsoft.com/dashboard)では、右上隅にある、**アカウントの設定**アイコンを選択し、**開発者の設定**を選択します。
2.  左側のナビゲーション メニューで、**受取りアカウント**を選択します。
...
1.  [パートナー センター](https://partner.microsoft.com/dashboard)では、右上隅にある、**アカウントの設定**アイコンを選択し、**開発者の設定**を選択します。
2.  左側のナビゲーション メニューで、**税務プロファイル**を選択します。

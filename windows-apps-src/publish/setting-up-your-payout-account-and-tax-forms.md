...
1.  [パートナー センター](https://partner.microsoft.com/dashboard)では、右上隅で**設定**ギア アイコンを選択し、**開発者向け設定**を選択します。
2.  [設定] ページの左側のナビゲーション メニューで、**受取りアカウント**を選択します。
...
1.  [パートナー センター](https://partner.microsoft.com/dashboard)では、右上隅で**アカウントの設定**アイコンを選択し、**開発者向け設定**を選択します。

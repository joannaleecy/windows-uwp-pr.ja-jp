...
単一用途のコードを生成する (して配布できます顧客ごとに 1 つ)、または指定したユーザー数によって複数回使用できるコードを生成することもできます。

...
各プロモーション コードには、1 人のユーザーまたはユーザーのグループに配布可能な引き換え用の一意の URL が含まれています。 ユーザーはこの URL をクリックするだけで、プロモーション コードを使って Microsoft Store からアプリまたはアドオンをインストールできます。
...
-   「[アプリ開発者契約](https://docs.microsoft.com/legal/windows/agreements/app-developer-agreement)」で規定されている要件に従う必要があります (セクション 3k「**プロモーション コード**」を含む)。


## <a name="order-promotional-codes"></a>プロモーション コードの注文

Microsoft Store に公開したアプリまたはアドオンのプロモーション コードを注文するには、次の手順を実行します。

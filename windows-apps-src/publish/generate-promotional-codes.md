...
ms.locfileid: "5594528"
---
# <a name="generate-promotional-codes"></a>プロモーション コードを生成する


Microsoft Store に公開したアプリまたはアドオンのプロモーション コードを生成できます。 プロモーション コードは、影響力を持つユーザーにアプリまたはアドオンへの無料アクセスを提供する簡単な方法です。 アプリやアドオン、または windows 10 に[ベータ テスト](beta-testing-and-targeted-distribution.md)への無料アクセスをユーザーに提供して顧客サービス シナリオに対応するプロモーション コードを使用することも可能性があります。 

...
単一用途のコードを生成する (して顧客ごとに 1 つの配布)、または指定したユーザー数で複数回使用できるコードを生成することもできます。

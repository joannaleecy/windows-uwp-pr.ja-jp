...
> [!NOTE]
> アプリがすべての要件を満たしていることを確認するのには、 [Microsoft ストア ポリシー](https://docs.microsoft.com/legal/windows/agreements/store-policies)を確認して表示します。
...
-   アプリが何かしらの方法で個人情報にアクセスする、または法律で義務付けられている場合など、アプリに[プライバシー ポリシー](create-app-store-listings.md#privacy-policy)が必要な場合は提供してください。 アプリにプライバシー ポリシーが必要かを判断するためには、[アプリ開発者の契約](https://docs.microsoft.com/legal/windows/agreements/app-developer-agreement)は、および[Microsoft ストア ポリシー](https://docs.microsoft.com/legal/windows/agreements/store-policies)を確認します。

...
| **制限付き機能**     | 必須の製品の宣言 [制限付き機能] (…/packaging/app-capability-declarations.md#restricted-capabilities    | [制限付き機能](manage-submission-options.md#publishing-hold-options)       

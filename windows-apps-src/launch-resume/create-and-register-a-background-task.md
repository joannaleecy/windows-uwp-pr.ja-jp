...
> [!NOTE]
> バック グラウンド タスク クラス自体&mdash;とバック グラウンド タスク プロジェクトで他のすべてのクラス&mdash; **sealed** (または**最終的な**) は**パブリック**クラスを使用する必要があります。
...
5.  **エントリ ポイント:** textbox、この例は、Tasks.ExampleBackgroundTask のバック グラウンド クラスの名前と名前空間を入力します。
6.  マニフェスト デザイナーを閉じます。

...
Fluent Design の効果 | これらの新しい効果は Fluent Design System の一部であり、重要な UI 要素にユーザーが専念できるように、深度、視点、および動きが使用されています。 </br>* [アクリル素材](../design/style/acrylic.md)は透過的なテクスチャを作成するブラシの一種です。 </br>* [視差効果](../design/motion/parallax.md)を使用すると、3 次元の深度と視点をアプリに追加できます。 </br>* [表示](../design/style/reveal.md)アプリの重要な要素が強調表示されます。 </br> 詳しくは、[Fluent Design の概要に関するページ](https://fluent.microsoft.com/)をご覧ください。
...
バックグラウンド タスク | バックグラウンド タスクの活用に役立つ次の 3 つのガイドを追加しました。</br></br> * [バック グラウンドで無期限に実行](../launch-resume/run-in-the-background-indefinetly.md)バック グラウンドまたは延長実行が制限なしのデバイスで使用可能なすべてのリソースを使用します。 これは、エンタープライズ UWP アプリと、Microsoft Store に提出されない UWP アプリに適用されます。 </br></br> * [アプリ内からバック グラウンド タスク トリガー](../launch-resume/trigger-background-task-from-app.md)から、アプリ内でのバック グラウンド タスクをアクティブ化します。 </br></br>* [UWP アプリが更新されたときに、バック グラウンド タスクを実行](../launch-resume/run-a-background-task-during-updatetask.md)UWP アプリが更新されるときに実行されるバック グラウンド タスクを作成します。
...
デスクトップ ブリッジ | Windows 10 のデスクトップ アプリケーションに最新のエクスペリエンスを実装するために役立つ 3 つのガイドが追加されました。 </br>* [Windows 10 のデスクトップ アプリケーションの拡張](../porting/desktop-to-uwp-enhance.md)を見つけて、適切なファイルを参照し、Windows 10 UWP エクスペリエンスを点灯するコードを作成します。 </br></br>* [最新の UWP コンポーネントを使用してデスクトップ アプリケーションを拡張](../porting/desktop-to-uwp-extend.md)を最新の XAML Ui と UWP アプリのコンテナー内で実行する必要があるその他の UWP エクスペリエンスに組み込むことです。 </br></br>* [ユニバーサル Windows プラットフォーム アプリケーションを移行](../porting/desktop-to-uwp-migrate.md)WPF、Windows フォーム、UWP、Android、および iOS アプリケーションでコードを共有します。
...
マイ連絡先 | マイ連絡先では、ユーザーがアプリケーションから直接、タスク バーに連絡先をピン留めできます。 [マイ ユーザー サポート、アプリケーションを追加する方法について説明します。](../contacts-and-calendar/my-people-support.md) </br></br>* [自分のユーザーが共有](../contacts-and-calendar/my-people-sharing.md)タスク バーから直接、アプリケーションを使用してファイルを共有することができます。 </br>* [ユーザー通知](../contacts-and-calendar/my-people-support.md)は新しいユーザーがピン留めされた連絡先を送信するトースト通知の種類。
...
タスク バーにピン留めする | 新しい TaskbarManager クラスでは、[アプリをタスク バーにピン留め](../design/shell/pin-to-taskbar.md)するようにユーザーに勧めることができます。
...
機能 | 説明
 :------ | :------
アカウント管理 | 柔軟性を提供するようになりましたとき[、パートナー センター アカウントと Azure AD テナントの関連付け](../publish/associate-azure-ad-with-dev-center.md)複数のアカウント ユーザーを追加します。 複数の Azure AD テナントを 1 つのパートナー センター アカウントに関連付けるか、1 つを関連付ける 1 つ以上のパートナー センター アカウントで Azure AD テナント。
...
ストア登録情報 | Store 登録情報が、利用を検討しているユーザーを引き付けることができる新機能によって強化されました。 </br>* アプリの Store 登録情報に[ビデオ トレーラー](../publish/app-screenshots-and-images.md#trailers)を含めることができるようになりました。 </br></br>* [Store 登録情報のインポートとエクスポート](../publish/import-and-export-store-listings.md)を使うと、更新にかかる時間を短縮できます。これは特に、登録情報を多数の言語で提供している場合に役立ちます。
...
ターゲット オファー | [ターゲット オファー](../publish/use-targeted-offers-to-maximize-engagement-and-conversions.md)では、特定のユーザー セグメントをターゲットに設定し、ユーザーに合わせた魅力的なコンテンツを提供して、エンゲージメント、ユーザー維持率、収益性を高めることができます。

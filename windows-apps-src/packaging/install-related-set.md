...
使用して、メイン アプリ パッケージが .appxbundle または .msixbundle ファイルの場合、`<MainBundle>`の下に表示します。 使用して、メイン アプリ パッケージが .appx または .msix ファイルの場合は、`<MainPackage>`の代わりに`<MainBundle>`スニペットにします。 

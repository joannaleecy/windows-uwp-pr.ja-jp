...
| [アプリ インストーラーで Windows 10 アプリをインストールする](https://docs.microsoft.com/windows/msix/app-installer/app-installer-root) | アプリ インストーラーを使用すると、アプリ パッケージをダブルクリックして Windows 10 アプリをインストールできます。 |

...
Microsoft Visual Studio ウィザードを使用してアプリ パッケージを作成する方法、またはストア向けのアプリ パッケージを構成、作成、テストする詳細な方法については、「[UWP アプリのパッケージ化](https://msdn.microsoft.com/windows/uwp/packaging/packaging-uwp-apps)」をご覧ください。

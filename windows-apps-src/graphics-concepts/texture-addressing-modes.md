...
<span data-ttu-id="c223d-149">次の図に、クランプされたテクスチャを示します。</span><span class="sxs-lookup"><span data-stu-id="c223d-149">The following illustration shows a clamped texture.</span></span>

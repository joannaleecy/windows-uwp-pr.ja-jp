---
title: "ラスター化規則の概要"
description: "頂点として指定された点が、画面上のピクセルと正確に一致しないことはよくあります。 この場合、Direct3D は三角形のラスター化ルールを適用し、指定された三角形に適用するピクセルを決定します。"
...
頂点として指定された点が、画面上のピクセルと正確に一致しないことはよくあります。 この場合、Direct3D は三角形のラスター化ルールを適用し、指定された三角形に適用するピクセルを決定します。

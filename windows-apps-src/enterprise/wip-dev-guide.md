...
<span data-ttu-id="b5228-111">完全なサンプルは、[ここ](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/EnterpriseDataProtection)にあります。</span><span class="sxs-lookup"><span data-stu-id="b5228-111">You can find a complete sample [here](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/EnterpriseDataProtection).</span></span>
...
### <a name="install-the-wip-setup-developer-assistant-onto-your-test-vm"></a><span data-ttu-id="b5228-126">テスト VM に WIP Setup Developer Assistant をインストールする</span><span class="sxs-lookup"><span data-stu-id="b5228-126">Install the WIP Setup Developer Assistant onto your test VM</span></span>
 ...
 <span data-ttu-id="b5228-127">テスト VM で Windows 情報保護ポリシーを設定するには、このツールを使用します。</span><span class="sxs-lookup"><span data-stu-id="b5228-127">Use this tool to setup a Windows Information Protection policy on your test VM.</span></span>
...
4. <span data-ttu-id="b5228-140">次の名前空間をパッケージ マニフェスト ファイルに追加します。</span><span class="sxs-lookup"><span data-stu-id="b5228-140">Add this namespace to your package manifest file:</span></span>
...
> **<span data-ttu-id="b5228-166">API</span><span class="sxs-lookup"><span data-stu-id="b5228-166">APIs</span></span>** <br>
...
<span data-ttu-id="b5228-177">エンドポイントがポリシーによって管理されていない場合、空の文字が返されます。</span><span class="sxs-lookup"><span data-stu-id="b5228-177">If the endpoint isn't managed by policy, you'll get back an empty string.</span></span>
...
* [<span data-ttu-id="b5228-252">別の場所にコピーしたファイルを保護する</span><span class="sxs-lookup"><span data-stu-id="b5228-252">Protect files that you copy to another location</span></span>](#protect-other-location)
...
**<span data-ttu-id="b5228-267">プロセスにタグを付ける</span><span class="sxs-lookup"><span data-stu-id="b5228-267">Tag the process</span></span>**
...
> **<span data-ttu-id="b5228-299">API</span><span class="sxs-lookup"><span data-stu-id="b5228-299">APIs</span></span>** <br>
...
**<span data-ttu-id="b5228-318">手順 3: ストリームやバッファーをファイルに書き込む</span><span class="sxs-lookup"><span data-stu-id="b5228-318">Step 3: Write both streams or buffers to a file</span></span>**
...
<span data-ttu-id="b5228-324">ファイルから企業データを読み取る方法を次に示します。</span><span class="sxs-lookup"><span data-stu-id="b5228-324">Here's how you'd read the enterprise data out of that file.</span></span>
...
**<span data-ttu-id="b5228-351">手順 2: 保護されたスレッド コンテキストを作成し、ネットワーク エンドポイントにデータを送信する</span><span class="sxs-lookup"><span data-stu-id="b5228-351">Step 2: Create a protected thread context and send data to the network endpoint</span></span>**
...
> **<span data-ttu-id="b5228-363">API</span><span class="sxs-lookup"><span data-stu-id="b5228-363">APIs</span></span>** <br>
...
<span data-ttu-id="b5228-375">機密データを保護し、保護されたファイル上でアプリが開いていたすべてのファイル ストリームを閉じることによって、システムでは、機密データがメモリ内にキャッシュされなくなります。</span><span class="sxs-lookup"><span data-stu-id="b5228-375">Protect sensitive data, and close any file streams that your app has opened on protected files to help ensure that the system doesn't cache any sensitive data in memory.</span></span>
...
> **<span data-ttu-id="b5228-377">API</span><span class="sxs-lookup"><span data-stu-id="b5228-377">APIs</span></span>** <br>
[<span data-ttu-id="b5228-378">ProtectionPolicyManager.ProtectedAccessSuspending</span><span class="sxs-lookup"><span data-stu-id="b5228-378">ProtectionPolicyManager.ProtectedAccessSuspending</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedaccesssuspending.aspx)<br>
[<span data-ttu-id="b5228-379">ProtectionPolicyManager.GetForCurrentView</span><span class="sxs-lookup"><span data-stu-id="b5228-379">ProtectionPolicyManager.GetForCurrentView</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.getforcurrentview.aspx)<br>
[<span data-ttu-id="b5228-380">ProtectionPolicyManager.Identity</span><span class="sxs-lookup"><span data-stu-id="b5228-380">ProtectionPolicyManager.Identity</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.aspx)</br>
[<span data-ttu-id="b5228-381">DataProtectionManager.ProtectAsync</span><span class="sxs-lookup"><span data-stu-id="b5228-381">DataProtectionManager.ProtectAsync</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.dataprotectionmanager.protectasync.aspx)<br>
[<span data-ttu-id="b5228-382">BufferProtectUnprotectResult.buffer</span><span class="sxs-lookup"><span data-stu-id="b5228-382">BufferProtectUnprotectResult.buffer</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.bufferprotectunprotectresult.buffer.aspx)<br>
[<span data-ttu-id="b5228-383">ProtectedAccessSuspendingEventArgs.GetDeferral</span><span class="sxs-lookup"><span data-stu-id="b5228-383">ProtectedAccessSuspendingEventArgs.GetDeferral</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectedaccesssuspendingeventargs.getdeferral.aspx)<br>
[<span data-ttu-id="b5228-384">Deferral.Complete</span><span class="sxs-lookup"><span data-stu-id="b5228-384">Deferral.Complete</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.foundation.deferral.complete.aspx)<br>

#### <a name="add-back-sensitive-data-when-the-device-is-unlocked"></a><span data-ttu-id="b5228-385">デバイスがロック解除されたときに、機密データを元に戻す</span><span class="sxs-lookup"><span data-stu-id="b5228-385">Add back sensitive data when the device is unlocked</span></span>

<span data-ttu-id="b5228-386">[**ProtectionPolicyManager.ProtectedAccessResumed**](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedaccessresumed.aspx) は、デバイスがロック解除され、キーがデバイスで再び利用可能になったときに発生します。</span><span class="sxs-lookup"><span data-stu-id="b5228-386">[**ProtectionPolicyManager.ProtectedAccessResumed**](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedaccessresumed.aspx) is raised when the device is unlocked and the keys are available on the device again.</span></span>

<span data-ttu-id="b5228-387">[**ProtectedAccessResumedEventArgs.Identities**](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectedaccessresumedeventargs.identities.aspx) は、管理者がロック ポリシーに従って安全なデータ保護を構成していない場合に、空のコレクションになります。</span><span class="sxs-lookup"><span data-stu-id="b5228-387">[**ProtectedAccessResumedEventArgs.Identities**](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectedaccessresumedeventargs.identities.aspx) is an empty collection if the administrator hasn't configured a secure data protection under lock policy.</span></span>

<span data-ttu-id="b5228-388">次の例では、前の例とは逆の処理を実行します。</span><span class="sxs-lookup"><span data-stu-id="b5228-388">This example does the reverse of the previous example.</span></span> <span data-ttu-id="b5228-389">バッファーの暗号化を解除し、そのバッファーからテキスト ボックスに情報を戻してから、バッファーを破棄します。</span><span class="sxs-lookup"><span data-stu-id="b5228-389">It decrypts the buffer, adds information from that buffer back to the textbox and then disposes of the buffer.</span></span>
...
> **<span data-ttu-id="b5228-390">API</span><span class="sxs-lookup"><span data-stu-id="b5228-390">APIs</span></span>** <br>
[<span data-ttu-id="b5228-391">ProtectionPolicyManager.ProtectedAccessResumed</span><span class="sxs-lookup"><span data-stu-id="b5228-391">ProtectionPolicyManager.ProtectedAccessResumed</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedaccessresumed.aspx)<br>
[<span data-ttu-id="b5228-392">ProtectionPolicyManager.GetForCurrentView</span><span class="sxs-lookup"><span data-stu-id="b5228-392">ProtectionPolicyManager.GetForCurrentView</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.getforcurrentview.aspx)<br>
[<span data-ttu-id="b5228-393">ProtectionPolicyManager.Identity</span><span class="sxs-lookup"><span data-stu-id="b5228-393">ProtectionPolicyManager.Identity</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.aspx)</br>
[<span data-ttu-id="b5228-394">DataProtectionManager.UnprotectAsync</span><span class="sxs-lookup"><span data-stu-id="b5228-394">DataProtectionManager.UnprotectAsync</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.dataprotectionmanager.unprotectasync.aspx)<br>
[<span data-ttu-id="b5228-395">BufferProtectUnprotectResult.Status</span><span class="sxs-lookup"><span data-stu-id="b5228-395">BufferProtectUnprotectResult.Status</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.bufferprotectunprotectresult.aspx)<br>

## <a name="handle-enterprise-data-when-protected-content-is-revoked"></a><span data-ttu-id="b5228-396">保護されたコンテンツが無効になった場合の企業データの処理</span><span class="sxs-lookup"><span data-stu-id="b5228-396">Handle enterprise data when protected content is revoked</span></span>

<span data-ttu-id="b5228-397">デバイスが MDM から登録解除されたとき、またはポリシー管理者が企業データへのアクセスを明示的に無効にしたときに、アプリに通知する必要がある場合は、[**ProtectionPolicyManager_ProtectedContentRevoked**](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedcontentrevoked.aspx) イベントを処理します。</span><span class="sxs-lookup"><span data-stu-id="b5228-397">If you want your app to be notified when the device is un-enrolled from MDM or when the policy administrator explicitly revokes access to enterprise data, handle the [**ProtectionPolicyManager_ProtectedContentRevoked**](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedcontentrevoked.aspx) event.</span></span>

<span data-ttu-id="b5228-398">次の例では、メール アプリ用の企業のメールボックス内にあるデータが無効になっているかどうかを確認します。</span><span class="sxs-lookup"><span data-stu-id="b5228-398">This example determines if the data in an enterprise mailbox for an email app has been revoked.</span></span>
...
> **<span data-ttu-id="b5228-399">API</span><span class="sxs-lookup"><span data-stu-id="b5228-399">APIs</span></span>** <br>
[<span data-ttu-id="b5228-400">ProtectionPolicyManager_ProtectedContentRevoked</span><span class="sxs-lookup"><span data-stu-id="b5228-400">ProtectionPolicyManager_ProtectedContentRevoked</span></span>](https://msdn.microsoft.com/library/windows/apps/windows.security.enterprisedata.protectionpolicymanager.protectedcontentrevoked.aspx)<br>

## <a name="related-topics"></a><span data-ttu-id="b5228-401">関連トピック</span><span class="sxs-lookup"><span data-stu-id="b5228-401">Related topics</span></span>

[<span data-ttu-id="b5228-402">Windows 情報保護 (WIP) API のサンプル</span><span class="sxs-lookup"><span data-stu-id="b5228-402">Windows Information Protection (WIP) sample</span></span>](http://go.microsoft.com/fwlink/p/?LinkId=620031&clcid=0x409)

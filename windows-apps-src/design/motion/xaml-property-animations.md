...
| [Scale](/uwp/api/windows.ui.xaml.uielement.scale) | Vector3 | スケール、要素の中心点の中央に配置 |
...
### <a name="example-animating-the-scale-property-with-a-vector3keyframeanimation"></a>例: Vector3KeyFrameAnimation をスケール プロパティをアニメーション化

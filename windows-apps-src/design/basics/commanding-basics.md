...
## <a name="choose-the-right-command-elements"></a>適切なコマンド要素を選ぶ

コマンド インターフェイスで適切な要素を使うことを直感的で使いやすいアプリと難しく、混乱を招くアプリの違いことができます。 包括的な一連のコマンド要素は、ユニバーサル Windows プラットフォーム (UWP) で使用できます。 次に、最も一般的な UWP コマンド要素の一部の一覧を示します。

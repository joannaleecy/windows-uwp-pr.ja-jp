...
ナビゲーションは、ユーザーの期待に沿ったものである必要があります。 [標準のコントロール](#use-the-right-controls)のユーザーに精通しているとアイコンの次の規則を使用すると、場所、およびスタイル設定、ナビゲーション予測可能かつ直感的なユーザーになります。
...
2. 高度なナビゲーション階層を避けてください。 3 レベルを超えるナビゲーションでは、ユーザーは迷ってしまい、深い階層から抜け出せなくなる可能性があります。
...
:::row:::
    ...
    :::column span="2":::
        ...
        - アイコンは、ナビゲーション カテゴリを明確に記述できません。
        
        タブを使用する場合。

        - ナビゲーション履歴とページの状態を維持するには。
        - ユーザーがタブを頻繁に切り替えるはずです。

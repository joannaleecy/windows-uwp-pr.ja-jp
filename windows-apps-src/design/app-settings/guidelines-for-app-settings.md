...
-   <span data-ttu-id="099f0-176">設定ポップアップへの設定コンテンツの追加</span><span class="sxs-lookup"><span data-stu-id="099f0-176">Add settings content to Settings flyouts</span></span>

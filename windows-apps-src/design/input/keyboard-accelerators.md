...
*ボタンの既定のツールヒントに追加のアクセス キーの組み合わせ*
...
*アクセス キーの組み合わせ AppBarButton の既定のヒントを追加します。*
...
*アクセス キーの組み合わせ MenuFlyoutItem のテキストを追加します。*

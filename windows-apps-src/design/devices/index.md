...
互換性のある windows 10 モバイル デバイスでは、新しいエクスペリエンスである電話用 Continuum では、ユーザーは電話をモニターに接続し、でも、マウスとキーボードを使用して、その電話ラップトップのように動作させる。 詳しくは、「[電話用 Continuum](https://go.microsoft.com/fwlink/p/?LinkID=699431)」をご覧ください。

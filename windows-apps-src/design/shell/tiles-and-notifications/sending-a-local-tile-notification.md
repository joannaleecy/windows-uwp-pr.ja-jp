...
<span data-ttu-id="0aaec-141">次のコード例では、通知をセカンダリ タイルに送信します。</span><span class="sxs-lookup"><span data-stu-id="0aaec-141">This code example sends a notification to a secondary tile.</span></span>

...
-   <span data-ttu-id="a89be-179">コンテキスト インジケーターの場合:</span><span class="sxs-lookup"><span data-stu-id="a89be-179">For context indicators:</span></span>

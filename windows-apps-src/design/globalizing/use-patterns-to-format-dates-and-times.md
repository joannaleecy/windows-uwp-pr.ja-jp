...
-   <span data-ttu-id="ecd61-140">書式設定の特定の出力に依存していない。</span><span class="sxs-lookup"><span data-stu-id="ecd61-140">You are not dependent on a particular output for a format.</span></span>

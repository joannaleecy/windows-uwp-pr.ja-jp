...
-   [
            ...
            ](https://msdn.microsoft.com/library/windows/apps/dn637016) メソッド - マップ コントロールのビューポート内の指定したポイントに対応する地理的な位置情報を取得します。
-   [
              **GetOffsetFromLocation**
            ](https://msdn.microsoft.com/library/windows/apps/dn637018) メソッド - 指定した地理的な位置情報に対応するマップ コントロールのビューポート内のポイントを取得します。
-   [
              **IsLocationInView**
            ](https://msdn.microsoft.com/library/windows/apps/dn637022) メソッド - 指定した地理的な位置がマップ コントロールのビューポート内に現在表示されているかどうかを調べます。
-   [
              **FindMapElementsAtOffset**
            ](https://msdn.microsoft.com/library/windows/apps/dn637014) メソッド - マップ コントロールのビューポート内の指定したポイントにある地図上の要素を取得します。
...
ユーザーやアプリによる地図の設定変更に対応するには、[**MapControl**](https://msdn.microsoft.com/library/windows/apps/dn637004) の次のイベントを処理します。. [マップのガイドライン](https://msdn.microsoft.com/library/windows/apps/dn596102) [CenterChanged](https://msdn.microsoft.com/library/windows/apps/dn596102)
...
-   [**関連トピック**](https://msdn.microsoft.com/library/windows/apps/dn637069)

## Bing Maps Developer Center

* [UWP の地図サンプル](https://www.bingmapsportal.com/)
* [現在の位置情報の取得](http://go.microsoft.com/fwlink/p/?LinkId=619977)
* [位置認識アプリの設計ガイドライン](get-location.md)
* [地図の設計ガイドライン](https://msdn.microsoft.com/library/windows/apps/hh465148)
* [Build 2015 のビデオ: Windows アプリでの電話、タブレット、PC で使用できるマップと位置情報の活用](https://msdn.microsoft.com/library/windows/apps/dn596102)
* [UWP の交通情報アプリのサンプル](https://channel9.msdn.com/Events/Build/2015/2-757)

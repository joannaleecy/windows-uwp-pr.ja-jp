...
-   位置情報サービスを再び有効にするための UI を用意します。 たとえば、更新ボタンを提供する、 [**Geolocator**](https://msdn.microsoft.com/library/windows/apps/br225534)オブジェクトを再し、もう一度位置情報の取得を試みます。

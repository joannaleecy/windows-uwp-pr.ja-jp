...
## <span id="Speech_interaction_design"></span><span id="speech_interaction_design"></span><span id="SPEECH_INTERACTION_DESIGN"></span>音声操作の設計
...
## <span id="Commanding"></span><span id="commanding"></span><span id="COMMANDING"></span>コマンド実行
...
## <span id="Always_listening"></span><span id="always_listening"></span><span id="ALWAYS_LISTENING"></span>常に聞き取る
...
## <span id="What_can_I_say_"></span><span id="what_can_i_say_"></span><span id="WHAT_CAN_I_SAY_"></span>音声操作の項目
...
## <span id="Recognition_failures"></span><span id="recognition_failures"></span><span id="RECOGNITION_FAILURES"></span>認識の失敗
...
## <span id="Constraints"></span><span id="constraints"></span><span id="CONSTRAINTS"></span>制約
...
### <span id="Predefined_grammars"></span><span id="predefined_grammars"></span><span id="PREDEFINED_GRAMMARS"></span>定義済みの文法
...
### <span id="Custom_grammars"></span><span id="custom_grammars"></span><span id="CUSTOM_GRAMMARS"></span>カスタム文法
...
## <span id="Testing"></span><span id="testing"></span><span id="TESTING"></span>テスト

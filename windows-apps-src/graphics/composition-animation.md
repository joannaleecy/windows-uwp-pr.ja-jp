...
|Lerp(Matrix4x4 value1, Matrix4x4 value2, Float progress)|  進行状況に基づいて 2 つの Matrix4x4 値の線形補間によって計算された結果を表す Matrix4x4 を返します (注: 進行状況は 0.0 ～ 1.0 です)。|

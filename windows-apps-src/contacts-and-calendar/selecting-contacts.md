...
## <a name="complete-example-multiple-contacts"></a><span data-ttu-id="e0c87-126">完全な例 (複数の連絡先)</span><span class="sxs-lookup"><span data-stu-id="e0c87-126">Complete example (multiple contacts)</span></span>

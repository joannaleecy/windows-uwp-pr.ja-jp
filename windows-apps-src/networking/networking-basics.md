...
[**ConnectAsync**](https://msdn.microsoft.com/library/windows/apps/hh701504) を使うと、ネットワーク サービスへの最初の接続を確立してすぐに、すべての通信で SSL/TLS を使うようにネゴシエートできます。 *protectionLevel* パラメーターを渡すことができる **ConnectAsync** メソッドは 2 つあります。

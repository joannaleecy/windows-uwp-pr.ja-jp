# [ユニバーサル Windows プラットフォームの概要](https://developer.microsoft.com/en-us/windows/getstarted)
...
### ["Hello, world" アプリを作成する (C#/VB)](get-started/create-a-hello-world-app-xaml-universal.md)
...
## [Windows の開発者向け新着情報](whats-new/windows-10-sdk-preview.md)
### [Windows 10 バージョン 1511 の新着情報](whats-new/windows-10-version-1511.md)
### [Windows 10 RTM の新着情報](whats-new/windows-10-rtm.md)
# [設計および UI](https://developer.microsoft.com/en-us/windows/design)
## [レイアウト](https://developer.microsoft.com/windows/design/layout)
...
#### [ピア ツー ピアのナビゲーションの実装](layout/peer-to-peer-navigation-between-two-pages.md)
...
## [スタイル](https://developer.microsoft.com/windows/design/style)
### [色](style/color.md)
### [アイコン](style/icons.md)
### [モーション](style/motion.md)
### [サウンド](style/sound.md)
...
## [コントロールとパターン](https://developer.microsoft.com/windows/design/controls-patterns)
### [はじめに](controls-and-patterns/controls-and-events-intro.md)
### [機能別コントロールのインデックス](controls-and-patterns/controls-by-function.md)
### [アクティブなキャンバス](controls-and-patterns/active-canvas.md)
...
### [メニュー、ダイアログ、ポップアップ](controls-and-patterns/dialogs-popups-menus.md)
...
#### [フォント](controls-and-patterns/fonts.md)
...
#### [Segoe MDL2 アイコン](controls-and-patterns/segoe-ui-symbol-font.md)
#### [スペル チェックと予測](controls-and-patterns/spell-checking-and-prediction.md)
#### [テキスト ブロック](controls-and-patterns/text-block.md)
#### [テキスト ボックス](controls-and-patterns/text-box.md)
### [タイル、バッジ、通知](controls-and-patterns/tiles-badges-notifications.md)
...
## [入力とデバイス](https://developer.microsoft.com/windows/design/inputs-devices)
...
#### [ペン入力とスタイラス](input-and-devices/pen-and-stylus-interactions.md)
...
## [ユーザビリティ](https://developer.microsoft.com/windows/design/usability)
...
## [ダウンロード](https://developer.microsoft.com/windows/design/assets)
# [Windows アプリの開発](https://developer.microsoft.com/windows/develop)
...
### [EDP を使ったアプリ間で転送されるエンタープライズ データの保護](app-to-app/use-edp-to-protect-enterprise-data-transferred-between-apps.md)
## [オーディオ、ビデオ、およびカメラ](audio-video-camera/index.md)
### [CameraCaptureUI を使った写真とビデオのキャプチャ](audio-video-camera/capture-photos-and-video-with-cameracaptureui.md)
### [MediaCapture を使った写真とビデオのキャプチャ](audio-video-camera/capture-photos-and-video-with-mediacapture.md)
#### [カメラ プロファイル](audio-video-camera/camera-profiles.md)
#### [メディア エンコード プロパティの設定](audio-video-camera/set-media-encoding-properties.md)
#### [ハイ ダイナミック レンジ (HDR) 写真のキャプチャ](audio-video-camera/high-dynamic-range-hdr-photo-capture.md)
#### [写真とビデオのキャプチャのためのキャプチャ デバイス コントロール](audio-video-camera/capture-device-controls-for-photo-and-video-capture.md)
#### [ビデオ キャプチャのためのキャプチャ デバイス コントロール](audio-video-camera/capture-device-controls-for-video-capture.md)
#### [ビデオ キャプチャの効果](audio-video-camera/effects-for-video-capture.md)
#### [メディア キャプチャのシーン分析](audio-video-camera/scene-analysis-for-media-capture.md)
#### [可変の写真シーケンス](audio-video-camera/variable-photo-sequence.md)
#### [プレビュー フレームの取得](audio-video-camera/get-a-preview-frame.md)
#### [シンプルなカメラ プレビューへのアクセス](audio-video-camera/simple-camera-preview-access.md)
...
### [メディア コンポジションと編集](audio-video-camera/media-compositions-and-editing.md)
### [オーディオ デバイス情報プロパティ](audio-video-camera/audio-device-information-properties.md)
### [イメージング](audio-video-camera/imaging.md)
#### [BitmapEncoder オプション リファレンス](audio-video-camera/bitmapencoder-options-reference.md)
#### [画像のメタデータ](audio-video-camera/image-metadata.md)
### [メディア ファイルのコード変換](audio-video-camera/transcode-media-files.md)
### [バックグラウンドでのメディア ファイルの処理](audio-video-camera/process-media-files-in-the-background.md)
### [MediaSource を使ったメディアの再生](audio-video-camera/media-playback-with-mediasource.md)
### [アダプティブ ストリーミング](audio-video-camera/adaptive-streaming.md)
### [バックグラウンド オーディオ](audio-video-camera/background-audio.md)
### [システム メディア トランスポート コントロール](audio-video-camera/system-media-transport-controls.md)
...
### [サポートされるコーデック](audio-video-camera/supported-codecs.md)
...
### [C# アプリでの Entity framework 7 と SQLite](data-access/entity-framework-7-with-sqlite-for-csharp-apps.md)
...
## [エンタープライズ](enterprise/index.md)
### [エンタープライズ データ保護 (EDP)](enterprise/edp-hub.md)
...
### [企業のデータ保護 (EDP) を使ったファイルの保護](files/protect-your-enterprise-data-with-edp.md)
### [エンタープライズ データ保護 (EDP) を使ったストリームとバッファーの保護](files/use-edp-to-protect-streams-and-buffers.md)
...
#### [バックグラウンド タスクの作成と登録](launch-resume/create-and-register-a-background-task.md)
...
## [アプリ収益の獲得と顧客エンゲージメント](monetize/index.md)
...
#### [Microsoft Advertising ライブラリを使用した広告の表示](monetize/display-ads-using-the-microsoft-advertising-libraries.md)
...
###### [AdMediatorControl と AdControl の違い](monetize/what-is-the-difference-admediatorcontrol-or-adcontrol.md)
...
#### [広告仲介を使って収益を最大限に高める](monetize/use-ad-mediation-to-maximize-revenue.md)
##### [広告ネットワークの選択と管理](monetize/select-and-manage-your-ad-networks.md)
##### [広告メディエーター コントロールの追加と使用](monetize/add-and-use-the-ad-mediator-control.md)
##### [広告の仲介の実装のテスト](monetize/test-your-ad-mediation-implementation.md)
##### [アプリの提出と広告の仲介の構成](monetize/submit-your-app-and-configure-ad-mediation.md)
##### [広告の仲介のトラブルシューティング](monetize/troubleshoot-ad-mediation.md)
### [A/B テストを使用してアプリの試験的機能を実行する](monetize/run-app-experiments-with-a-b-testing.md)
#### [デベロッパー センター ダッシュボードで試験的機能を定義する](monetize/define-your-experiment-in-the-dev-center-dashboard.md)
#### [アプリで試験的機能のコードを記述する](monetize/code-your-experiment-in-your-app.md)
#### [デベロッパー センター ダッシュボードで試験的機能を管理する](monetize/manage-your-experiment.md)
#### [A/B テストを使用して最初の試験的機能を作成および実行する](monetize/create-and-run-your-first-experiment-with-a-b-testing.md)
...
##### [IAP の入手数の取得](monetize/get-in-app-acquisitions.md)
...
### [EDP ID を使ったネットワーク接続のタグ付け](networking/tagging_network_connections_with_edp_identity.md)
...
## [Windows 10 にアプリを移植する](porting/index.md)
...
#### [Desktop App Converter プレビュー (Project Centennial)](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Windows デスクトップ アプリを UWP へ手動で変換する](porting/desktop-to-uwp-manual-conversion.md)
#### [変換済みのデスクトップ アプリに署名する](porting/desktop-to-uwp-signing.md)
#### [変換済みの UWP アプリを展開してデバッグする](porting/desktop-to-uwp-deploy-and-debug.md)
...
#### [Web アカウント マネージャー ブローカー](security/web-account-manager.md)
...
### [Xbox One 開発者モードのライセンス認証](xbox-apps/devkit-activation.md)
### [Xbox One ツールの概要](xbox-apps/introduction-to-xbox-tools.md)
### [開発環境のセットアップ](xbox-apps/development-environment-setup.md)
### [ベスト プラクティス](xbox-apps/tailoring-for-xbox.md)
...
### [C# および Visual Basic での Windows ランタイム コンポーネントの作成](winrt-components/creating-windows-runtime-components-in-csharp-and-visual-basic.md)
...
## [サービス](https://developer.microsoft.com/en-us/windows/develop/microsoft-services)
...
# [Windows アプリの公開](https://developer.microsoft.com/en-us/windows/publish)
...
### [アプリの説明の作成](publish/create-app-descriptions.md)
#### [人の心をつかむアプリの説明を書く](publish/write-a-great-app-description.md)
#### [アプリのスクリーンショットと画像](publish/app-screenshots-and-images.md)
#### [プラットフォーム固有の説明の作成](publish/create-platform-specific-descriptions.md)
### [認定を求めるにあたってのコメント](publish/notes-for-certification.md)
...
## [IAP の申請](publish/iap-submissions.md)
### [IAP の製品 ID の設定](publish/set-your-iap-product-id.md)
### [IAP のプロパティの入力](publish/enter-iap-properties.md)
### [IAP の価格と使用可能状況の設定](publish/set-iap-pricing-and-availability.md)
### [IAP の説明の作成](publish/create-iap-descriptions.md)
## [広告による収益獲得](publish/monetize-with-ads.md)
### [アフィリエイト広告について](publish/about-affiliate-ads.md)
### [pubCenter とデベロッパー センターの統合](publish/pubcenter-dev-center-integration.md)
...
### [レーティング レポート](publish/ratings-report.md)
### [レビュー レポート](publish/reviews-report.md)
### [フィードバック レポート](publish/feedback-report.md)
### [利用状況レポート](publish/usage-report.md)
### [IAP 取得レポート](publish/iap-acquisitions-report.md)
### [広告仲介レポート](publish/ad-mediation-report.md)
...
### [アプリと IAP の販売](publish/put-apps-and-iaps-on-sale.md)
...
## [ストアのポリシーと倫理規定](https://msdn.microsoft.com/en-us/library/windows/apps/dn764939.aspx)

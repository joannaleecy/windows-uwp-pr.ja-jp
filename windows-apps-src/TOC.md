...
### [IAP の一括管理](publish/manage-iaps-in-bulk.md)
...
### [Microsoft Advertising の支払処理](publish/microsoft-advertising-payment-process.md)
### [有料アプリの税の詳細](publish/tax-details-for-paid-apps.md)
### [通信事業者の請求](publish/mobile-operator-billing.md)
### [VAT 情報](publish/vat-info.md)
...
### [アプリの品質](https://msdn.microsoft.com/en-us/library/windows/apps/mt652261.aspx)

# [ユニバーサル Windows プラットフォームの概要](https://developer.microsoft.com/windows/getstarted)
...
# [設計および UI](https://developer.microsoft.com/windows/design)
...
#### [変換されたデスクトップ アプリの拡張機能](porting/desktop-to-uwp-extensions.md)
...
#### [機能へのアクセス](porting/hwa-access-features.md)
...
### [携帯電話会社による課金](publish/mobile-operator-billing.md)

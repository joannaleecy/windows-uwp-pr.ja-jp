...
### [Windows 10 バージョン 1607での API の追加](whats-new/windows-10-version-1607-api-diff.md)
### [Windows 10 Anniversary SDK Preview の新着情報](whats-new/windows-10-sdk-preview.md)
...
#### [アプリとアドオンの情報の取得](monetize/get-info-for-apps-and-add-ons.md)
#### [アプリやアドオンの購入](monetize/purchase-an-app-or-add-on.md)
#### [アプリのライセンス情報の取得](monetize/get-license-info-for-your-app.md)
#### [アプリの試用版の実装](monetize/implement-a-trial-version-of-your-app.md)
#### [コンシューマブルなアドオンの管理](monetize/manage-consumable-add-ons.md)
#### [Windows 10 バージョン 1607 より前のアプリ内購入と試用版](monetize/in-app-purchases-and-trials-before-windows-10-version-1607.md)

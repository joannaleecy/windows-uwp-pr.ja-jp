# [ユニバーサル Windows プラットフォームの概要](https://dev.windows.com/en-us/getstarted)
...
# [設計および UI](https://dev.windows.com/en-us/design)
## [レイアウト](https://dev.windows.com/design/layout)
...
## [スタイル](https://dev.windows.com/design/style)
### [色](style/color.md)
### [アイコン](style/icons.md)
...
## [コントロールとパターン](https://dev.windows.com/design/controls-patterns)
...
## [入力とデバイス](https://dev.windows.com/design/inputs-devices)
...
#### [ゲームパッドとリモコンの操作](input-and-devices/gamepad-and-remote-interactions.md)
...
## [ユーザビリティ](https://dev.windows.com/design/usability)
...
## [Microsoft デザイン言語](https://dev.windows.com/design/microsoft-design-language)
## [ダウンロード](https://dev.windows.com/design/assets)
# [Windows アプリの開発](http://dev.windows.com/develop)
...
#### [モバイル向けのデバイス ポータル](debug-test-perf/device-portal-mobile.md)
#### [Xbox 向けのデバイス ポータル](debug-test-perf/device-portal-xbox.md)
...
#### [コンパニオン デバイスのロック解除](security/companion-device-unlock.md)
...
## [サービス](https://dev.windows.com/en-us/develop/microsoft-services)
...
# [Windows アプリの公開](https://dev.windows.com/en-us/publish)

...
#### [ゲームパッドとリモート制御](input-and-devices/gamepad-and-remote-interactions.md)
...
#### [PlayReady の暗号化されたメディア拡張子](audio-video-camera/playready-encrypted-media-extension.md)
...
### [People アプリにソーシャル フィードを提供する](contacts-and-calendar/integrating-social-feeds-into-contact-cards.md)
...
### [接続されているアプリとデバイス](launch-resume/connected-apps-and-devices.md)
#### [リモート デバイスの検出](launch-resume/discover-connected-devices.md)
...
### [アプリの URI ハンドラーによる Web とアプリのリンクの処理](launch-resume/web-to-app-linking.md)
...
#### [別のプロセスで実行するバックグラウンド タスクの作成と登録](launch-resume/create-and-register-a-background-task.md)
#### [単一プロセスで実行するバックグラウンド タスクの作成と登録](launch-resume/create-and-register-a-singleprocess-background-task.md)
#### [マルチプロセスのバックグラウンド タスクを単一プロセスのバックグラウンド タスクへ変換](launch-resume/convert-multiple-process-background-task.md)
...
### [リモート アプリ サービスとの通信](launch-resume/communicate-with-a-remote-app-service.md)
### [ホスト アプリと同じプロセスで実行するようにアプリ サービスを変換する](launch-resume/convert-app-service-single-process.md)
### [スプラッシュ スクリーンの追加](launch-resume/add-a-splash-screen.md)
...
##### [広告仲介のトラブルシューティング](monetize/troubleshoot-ad-mediation.md)
### [A/B テストを使用してアプリの実験を実行する](monetize/run-app-experiments-with-a-b-testing.md)
#### [プロジェクトを作成し、デベロッパー センター ダッシュボードでリモート変数を定義する](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
#### [アプリの実験用のコードを記述する](monetize/code-your-experiment-in-your-app.md)
#### [デベロッパー センター ダッシュボードで実験を定義する](monetize/define-your-experiment-in-the-dev-center-dashboard.md)
...
#### [変換されたデスクトップ アプリでサポートされている UWP API](porting/desktop-to-uwp-supported-api.md)

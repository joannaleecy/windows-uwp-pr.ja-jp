...
キャスト メディア コンテンツと DIAL を使う場合は、それぞれに独自のピッカーが用意されています。 [
            **CastingDevicePicker**](https://msdn.microsoft.com/library/windows/apps/Dn972525) と [**DialDevicePicker**](https://msdn.microsoft.com/library/windows/apps/Dn946783) です。
...
| バックグラウンド スキャンはサポートされていない            | [
            **DeviceWatcherTrigger**](https://msdn.microsoft.com/library/windows/apps/Dn913838) でデバイスが検出されず、更新も報告されません。 |

...
-   [**検出と起動 (ダイヤル)**](https://msdn.microsoft.com/library/windows/apps/Dn946818)
-   [**DNS サービス探索 (DNS SD)**](https://msdn.microsoft.com/library/windows/apps/Dn895183)
...
**注**  指定することはできません、 [ **DeviceInformationKind** ](https://msdn.microsoft.com/library/windows/apps/windows.devices.enumeration.deviceinformationkind.aspx)を使用して、 [ **DevicePicker**](https://msdn.microsoft.com/library/windows/apps/Dn930841)します。 特定の **DeviceInformationKind** のデバイスが必要な場合は、[**DeviceWatcher**](https://msdn.microsoft.com/library/windows/apps/BR225446) を作成して独自の UI を提供する必要があります。

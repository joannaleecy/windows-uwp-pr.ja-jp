    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void TrimClipBeforeCurrentPosition()
        {
            var currentClip = composition.Clips.FirstOrDefault(
                mc => mc.StartTimeInComposition <= mediaElement.Position &&
                mc.EndTimeInComposition >= mediaElement.Position);

            TimeSpan positionFromStart = mediaElement.Position - currentClip.StartTimeInComposition;

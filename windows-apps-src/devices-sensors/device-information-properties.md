...
| **System.Devices.Aep.CanPair**        | Boolean    | デバイスがシステムとペアリングされているかどうかを示します。 [
            ...
            ](https://msdn.microsoft.com/en-us/library/windows/apps/windows.devices.enumeration.deviceinformationpairing.canpair.aspx) はこのプロパティから派生します。                                                                                                                                                                                                                                                                                                       |
...
| **System.Devices.Aep.IsPaired**       | Boolean    | デバイスが現在ペアリングされているかどうかを示します。 [
            ...
            ](https://msdn.microsoft.com/en-us/library/windows/apps/windows.devices.enumeration.deviceinformationpairing.ispaired.aspx) はこのプロパティから派生します。                                                                                                                                                                                                                                                                                                                      |

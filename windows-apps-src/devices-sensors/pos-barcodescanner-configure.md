...
使用してペアリングする必要があります、Bluetooth バーコード スキャナーを使用する前に**設定 _gt デバイス _gt Bluetooth & 他のデバイス _gt 追加 Bluetooth またはその他のデバイス**します。

...
2 つの入力画像と、低光量 Fusion アルゴリズムを適用した結果の出力画像の例を示します。

> [!div class="mx-tableFixed"] 
| フレーム 1 | フレーム 2 | 低光量 Fusion による出力 | 
|---------|---------|-------------------------|
...
入力フレーム、およびカップのライティングと鮮明度が改善された出力フレームを見ると、周囲に写っているもの (カーペットの横にある装飾物など) の鮮明度が改善されたことも確認できます。

...
-   [**CapturedFrame** ](https://msdn.microsoft.com/library/windows/apps/dn278725)としてカメラによってキャプチャされたフレームを取得することができます、 **SoftwareBitmap**します。

-   [**VideoFrame** ](https://msdn.microsoft.com/library/windows/apps/dn930917)を取得することができます、 **SoftwareBitmap**の表現、 **VideoFrame**します。

-   [**FaceDetector** ](https://msdn.microsoft.com/library/windows/apps/dn974129)で顔を検出することができます、 **SoftwareBitmap**します。

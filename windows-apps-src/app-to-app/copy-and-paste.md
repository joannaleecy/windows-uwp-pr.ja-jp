...
* [制御](https://msdn.microsoft.com/library/windows/apps/xaml/mt185406.aspx)
...
* [含まれています](https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.datatransfer.datapackageview.contains.aspx)

...
ms.locfileid: "5682779"
---
<div> 
<h1>UWP アプリの開発</h1>
<p>Windows 10 用の UWP アプリを作成するためハウツー記事とコードです。 </p> 
</div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>ユニバーサル Windows プラットフォームの概要</h3>
                        <p>UWP の概要、しくみ、それが提供する機能についての説明です。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>移植ガイド</h3>
                        <p>既存の Windows フォーム、WPF、Android、または iOS アプリを UWP に移植します。 </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Windows UWP 名前空間</h3>
                        <p>名前空間によって整理され、Windows ランタイムを構成するクラス、構造体、インターフェイス、メソッド、プロパティ、およびイベントです。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>UWP のスキーマ</h3>
                        <p>ユニバーサル Windows プラットフォーム (UWP) アプリのファイルと XML スキーマの仕様 </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div style="display:block" class="cardPadding">
                <div style="display:block" class="card">
                    <div style="display:block" class="cardText">
                        <h3>アプリの種類</h3>
                        <p style="display: block;"><a  href="/windows/uwp/apps-for-education/">教育アプリ</a></p>
                        <p style="display: block;"><a  href="/windows/uwp/enterprise/">エンタープライズ アプリ</a></p>
                        <p style="display: block;"><a  href="/windows/uwp/gaming/">ゲームと DirectX アプリ</a></p>
                        <p style="display: block;"><a  href="/microsoft-edge/progressive-web-apps">プログレッシブ Web アプリ</a></p>
                    </div>
                </div>
            </div>
        </div>        
        ...
        <div style="display:block" class="cardSize">
            <div style="display:block" class="cardPadding">
                <div style="display:block" class="card">
                    <div style="display:block" class="cardText">
                        <h3>アプリの UI</h3>
                        <p><a href="https://developer.microsoft.com/windows/apps/design">コントロール、レイアウト、文字体裁、アニメーション、使いやすさ、および UI 設計については、設計と UI のセクションを参照してください。</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="display:block" class="cardSize">
            <div style="display:block" class="cardPadding">
                <div style="display:block" class="card">
                    <div style="display:block" class="cardText">
                        <h3>通信</h3>
                        <p><a style="display:block" href="/windows/uwp/app-to-app/">アプリ間通信</a></p>
                        <p><a style="display:block" href="/windows/uwp/networking/">ネットワークと Web サービス</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div style="display:block" class="cardPadding">
                <div style="display:block" class="card">
                    <div style="display:block" class="cardText">
                        ...
                        <p style="display:block"><a href="/windows/uwp/xaml-platform/">XAML プラットフォーム</a></p>                    
                    </div>
                </div>
            </div>
        </div>        
        ...
        <div style="display:block" class="cardSize">
            <div style="display:block" class="cardPadding">
                <div style="display:block" class="card">
                    <div style="display:block" class="cardText">
                        <h3>人や場所</h3>
                        <p style="display:block"><a href="/windows/uwp/contacts-and-calendar/">連絡先、マイ連絡先、カレンダー</a></p>
                        <p style="display:block"><a href="/windows/uwp/maps-and-location/">マップと位置情報</a></p>
                    </div>
                </div>
            </div>
        </div>        
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>サンプル</h3>
                        <p> これらのサンプルを参考に、優れた Windows アプリを構築する方法を習得してください。 これらのサンプルからさまざまな機能の動作を知ることができ、独自の UWP アプリ開発にすぐに応用できます。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開発者ツール</h3>
                        <p>Visual Studio 2017、Windows 10 SDK、およびその他の開発者ツールを入手してください。</p>
                    </div>
                </div>
            </div>
        </div>

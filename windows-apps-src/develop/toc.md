...
### [C++/WinRT でのコレクション](../cpp-and-winrt-apis/collections.md)
...
### [C++/WinRT での COM コンポーネントの使用](../cpp-and-winrt-apis/consume-com.md)
### [C++/WinRT での COM コンポーネントの作成](../cpp-and-winrt-apis/author-coclasses.md)

...
XAML UI でのブラシの使い方について詳しくは、「[**ブラシ**](../graphics/using-brushes.md#xamlcompositionbrushbase)」セクションをご覧ください。
...
これは、同じ XAML 構造を使用する、以前の C&#35; コードと同等の [C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx) です。
